             ...
             <div runat="server" ID="pnlgrdRequest" style="Height:460px;Width:978px;overflow:auto;direction:ltr;">
                <asp:GridView ID="grdRequest" runat="server"  GridLines="None"  ShowHeader="true"
                    ...
                    <Columns>
                         ...
                         <asp:BoundField DataField="ZMAN_HATCHALA" HeaderText="זמן תחילת ריצה" SortExpression="ZMAN_HATCHALA" ItemStyle-Width="80px" ItemStyle-CssClass="ItemRow" HeaderStyle-CssClass="GridHeader"  DataFormatString="{0:dd/MM/yyyy  HH:mm}" HtmlEncodeFormatString="true"/>
                         <asp:BoundField DataField="ZMAN_Siyum" HeaderText="זמן סיום ריצה" SortExpression="ZMAN_Siyum" ItemStyle-Width="80px" ItemStyle-CssClass="ItemRow" HeaderStyle-CssClass="GridHeader"   DataFormatString="{0:dd/MM/yyyy  HH:mm}" HtmlEncodeFormatString="true"/>
