             ...
             <br /> 
                <asp:GridView ID="grdLogTahalich" runat="server"  GridLines="None"  ShowHeader="true"
                 ...
                 onpageindexchanging="grdLogTahalich_PageIndexChanging">
                    <Columns>
                         <asp:BoundField DataField="TAARICH" HeaderText="תאריך" SortExpression="TAARICH" DataFormatString="{0:dd/MM/yyyy  HH:mm:ss}" HtmlEncodeFormatString="true"  ItemStyle-CssClass="ItemRow" HeaderStyle-CssClass="GridHeader"  />
