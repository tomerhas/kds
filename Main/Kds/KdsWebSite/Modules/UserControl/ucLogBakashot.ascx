                ...
                <asp:GridView ID="grdLogRequest" runat="server"  GridLines="None"  ShowHeader="true"
                 ...
                 onpageindexchanging="grdLogRequest_PageIndexChanging">
                    <Columns>
                         ...
                         <asp:BoundField DataField="TAARICH_IDKUN_ACHARON" HeaderText="תאריך עדכון" SortExpression="TAARICH_IDKUN_ACHARON" ItemStyle-Width="80px" ItemStyle-CssClass="ItemRow" HeaderStyle-CssClass="GridHeader"  DataFormatString="{0:dd/MM/yyyy  HH:mm}" HtmlEncodeFormatString="true"/>
