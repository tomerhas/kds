    ...
    protected void grdPeiluyot_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if ( e.Row.RowType == DataControlRowType.DataRow || e.Row.RowType == DataControlRowType.Separator)
            {
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.SHAT_YETZIA].Controls[1]).Attributes.Add("onfocus", "this.className='WorkCardPeilutTextBoxFocus';");
                ((TextBox)e.Row.Cells[(int)enPeilut.SHAT_YETZIA].Controls[1]).Attributes.Add("onblur", "this.className='WorkCardPeilutTextBox';");
                ((TextBox)e.Row.Cells[(int)enPeilut.KISUY_TOR].Controls[1]).Attributes.Add("onfocus", "this.className='WorkCardSidurTextBoxFocus';");
                ((TextBox)e.Row.Cells[(int)enPeilut.KISUY_TOR].Controls[1]).Attributes.Add("onblur", "this.className='WorkCardPeilutTextBox';");
             ...
             //?       ((HtmlInputText)e.Row.Cells[(int)enPeilut.MISPAR_RISHUY].FindControl("lblMisparRishuy")).Value = e.Row.Cells[(int)enPeilut.hidMisRishuy].Text;
               ...
               // ((AjaxControlToolkit.ValidatorCalloutExtender)e.Row.Cells[(int)enPeilut.MISPAR_RECHEV].FindControl("exvMakat")).BehaviorID = e.Row.ClientID + "_vldExvldMakat";
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.MAKAT].FindControl("txtMakat")).Attributes.Add("onblur ", "this.className='WorkCardPeilutTextBox';");
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.DAKOT_BAFOAL].FindControl("txtDakotBafoal")).Attributes.Add("onblur ", "this.className='WorkCardPeilutTextBox';");
