...
namespace KdsBatch.KdsServiceProxy {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="clGeneral.enCalcType", Namespace="http://schemas.datacontract.org/2004/07/KdsLibrary")]
    public enum clGeneralenCalcType : int {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="clGeneral.BatchExecutionType", Namespace="http://schemas.datacontract.org/2004/07/KdsLibrary")]
    public enum clGeneralBatchExecutionType : int {
    ...
    public interface IBatchService {
        ...
        void ShinuyimVeShguimBatch(long lRequestNum, System.DateTime dTaarich, KdsBatch.KdsServiceProxy.clGeneralenCalcType TypeShguyim, KdsBatch.KdsServiceProxy.clGeneralBatchExecutionType ExecutionTypeShguim);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBatchService/InsetRecordsToHistory", ReplyAction="http://tempuri.org/IBatchService/InsetRecordsToHistoryResponse")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBatchService/TransferTekenNehagim", ReplyAction="http://tempuri.org/IBatchService/TransferTekenNehagimResponse")]
        void TransferTekenNehagim(long lRequestNum, long iRequestIdForTransfer);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBatchService/ShlichatRikuzimMail", ReplyAction="http://tempuri.org/IBatchService/ShlichatRikuzimMailResponse")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBatchService/TkinutMakatimBatch", ReplyAction="http://tempuri.org/IBatchService/TkinutMakatimBatchResponse")]
    ...
    public partial class BatchServiceClient : System.ServiceModel.ClientBase<KdsBatch.KdsServiceProxy.IBatchService>, KdsBatch.KdsServiceProxy.IBatchService {
        ...
        public void ShinuyimVeShguimBatch(long lRequestNum, System.DateTime dTaarich, KdsBatch.KdsServiceProxy.clGeneralenCalcType TypeShguyim, KdsBatch.KdsServiceProxy.clGeneralBatchExecutionType ExecutionTypeShguim) {
        ...
        public void InsetRecordsToHistory(long lRequestNum) {
            base.Channel.InsetRecordsToHistory(lRequestNum);
        }
        ...
        public void TransferTekenNehagim(long lRequestNum, long iRequestIdForTransfer) {
            base.Channel.TransferTekenNehagim(lRequestNum, iRequestIdForTransfer);
        }
        
        public void ShlichatRikuzimMail(long lRequestNum, long iRequestIdForRikuzim) {
            base.Channel.ShlichatRikuzimMail(lRequestNum, iRequestIdForRikuzim);
        }
        ...
        public void TkinutMakatimBatch(System.DateTime dTaarich) {
