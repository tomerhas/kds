...
namespace KdsBatch
{
    class CalcMonth
    {
        ...
        private void CalcNochehutVeMichsaChelkiim(ref float fNochehutChodshitChelkit,ref float fMichsaChodshitChelkit,string sTnaim, clGeneral.enRechivim KodRechiv,bool bTaluyRechivimAcherim)
        {
            DataRow[] days,dr;
            DateTime taarich;
            try
        ...
        {
            float fSumDakotRechiv,fHashlama, fNosafot100;
            try
            {
                if (objOved.objMeafyeneyOved.iMeafyen56 == clGeneral.enMeafyenOved56.enOved5DaysInWeek2.GetHashCode())
                {
                  ...
                  //  CalcNochehutVeMichsaChelkiim(ref fNochehutChodshitChelkit, ref fMichsaChodshitChelkit);
