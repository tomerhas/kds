    ...
    class CalcDay
    {
      ...
      //  public int SugYom { get; set; }
        ...
        private void CalcRechiv22()
        {
            ...
            float fSumDakotTafkid4,fErechRechiv,fNochechtKursim, fDakotNehiga,fErechRechivSidur=0, fMichsaYomit126, fNochechtLeTashlum,sum,fMichsatMutam,fTempX;
            DataRow[] drSidurim;
            DataRow[] dr;
            int iSugSidur;
                    ...
                    && (objOved.objMeafyeneyOved.sMeafyen63 != "" || objOved.objMeafyeneyOved.sMeafyen63 != "0") && objOved.objMeafyeneyOved.iMeafyen33 == 1))
                {
                    ...
                    if (rowSidur.Length == 0)
                    {
                        ...
                        if (!(rowSidur.Length > 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.iMeafyen33 == 1))
                        {
                            ...
                            //ה
                            if ((objOved.objPirteyOved.iMutamBitachon == 4 || objOved.objPirteyOved.iMutamBitachon == 5 || objOved.objPirteyOved.iMutamBitachon == 6 || objOved.objPirteyOved.iMutamBitachon == 8 || objOved.objPirteyOved.iMutamut == 1) && fMichsaYomit > 0 && objOved.objPirteyOved.iZmanMutamut>0)
                            {
        ...
        public void CalcRechiv126(DateTime dTaarich)
        {
            ...
            int iSugYom, iSugMishmeret, iSugYomLemichsa, iMeafyen1;
            DataRow[] rowSidurim;
        ...
        {
            //שבת/שעות 100% (רכיב 131):
            float fErechRechiv, fTempY, fDakotNocheut, fMichsaYomit, fShaot100, fShaot100ET, fDakotNocheutGmar,fZmanAdShabat=0;
            string sSidurim="";
            DataRow[] dr;
            try
            {
                ...
                oSidur.CalcRechiv131(ref fZmanAdShabat);
