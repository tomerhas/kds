    ...
    class CalcSidur
    {
      ...
      //  public int SugYom { get; set; }
        ...
        public void CalcRechiv26()
        {
            ...
            try
            {
                ...
                for (int I = 0; I <= _drSidurMeyuchad.Length - 1; I++)
                {
                    ...
                    bHoraatNehigaLechishuv = true;
                    iMisparSidur = int.Parse(_drSidurMeyuchad[I]["mispar_sidur"].ToString());
                    if (_drSidurMeyuchad[I]["sug_avoda"].ToString() == clGeneral.enSugAvoda.Nahagut.GetHashCode().ToString() && objOved.Month >= objOved.objParameters.dTaarichBitulPremiaNahagutForHoraa)
                        bHoraatNehigaLechishuv = false;
            ...
            try
            {
                ...
                else 
                {
                    ...
                    else
                    {
                     ...
                     //   bYeshSidur = CheckSugSidur(clGeneral.enMeafyen.SectorAvoda.GetHashCode(), clGeneral.enSectorAvoda.Nihul.GetHashCode(), objOved.Taarich, iSugSidur);
                     // bYeshSidur || 
                        if (drSidurim["matala_klalit_lelo_rechev"].ToString()!="" && drPeiluyot.Length > 0) // && clCalcGeneral.objOved.objMeafyeneyOved.iMeafyen33))
                            bSidurNihulTnua = true;
                    }
                }
        ...
        public void CalcRechiv296()
        {
            ...
            {
                clLogBakashot.SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanElementZarNahagut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "CalcSidur: " + ex.StackTrace + "\n message: " + ex.Message, null);
                throw (ex);
            }
        }
