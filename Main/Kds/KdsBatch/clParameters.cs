            ...
            try
            {
              ...
              //209 - מפעילים משמרת לילה חול מינימום התחלה
               ...
               //210 - מפעילים משמרת לילה חול מינימום סיום  תלוי התחלה
                ...
                dTaarichTokefShgiotHachtamatShaon = String.IsNullOrEmpty(sTmp) ? DateTime.MaxValue : DateTime.Parse(sTmp);
                ...
                dTaarichBitulEshel = String.IsNullOrEmpty(sTmp) ? DateTime.MinValue : DateTime.Parse(sTmp);
