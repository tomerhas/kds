...
driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	  ...
	  Work_Card.Wait_For_Element_Stalenes(driver, "btnAddHeadrut",null);
      ...
      Assert.assertEquals(Work_Card.Lbl_Sidur_Num_0(driver).getText(),"99801");
      ...
      Assert.assertEquals(Work_Card.Lbl_Sidur_Num_0(driver).getText(),"99830");
      Work_Card.Date(driver).click();
