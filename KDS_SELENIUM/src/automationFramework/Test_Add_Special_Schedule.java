...
public class Test_Add_Special_Schedule  extends Base {
  ...
  public void Test_Add_Special_Schedule () {
	  ...
	  Work_Card.Lbl_Sidur_Num_0(driver).clear();
	  Work_Card.Lbl_Sidur_Num_0(driver).sendKeys("99200");
	  ...
	  Work_Card.Lbl_Sidur_Num_0(driver).sendKeys("99301");
	  Work_Card.Lbl_Sidur_Num_0(driver).sendKeys(Keys.TAB);
	  ...
	  Work_Card.Wait_For_Element_Stalenes(driver, "SD_imgCancel2",null);
