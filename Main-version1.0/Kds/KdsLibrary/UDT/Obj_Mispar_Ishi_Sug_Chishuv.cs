...
namespace KdsLibrary.UDT
{
    ...
    public class OBJ_MISPAR_ISHI_SUG_CHISHUV : INullable, IOracleCustomType, IXmlSerializable
    {
        ...
        public OBJ_MISPAR_ISHI_SUG_CHISHUV()
        {
        ...
        public OBJ_MISPAR_ISHI_SUG_CHISHUV(string str)
        {
        ...
        public static OBJ_MISPAR_ISHI_SUG_CHISHUV Null
        {
            get
            {
                OBJ_MISPAR_ISHI_SUG_CHISHUV obj = new OBJ_MISPAR_ISHI_SUG_CHISHUV();
                obj.m_IsNull = true;
                return obj;
            }
        }
        ...
        public static OBJ_MISPAR_ISHI_SUG_CHISHUV Parse(string str)
        {
            // TODO : Add code needed to parse the string and get the object represented by the string
            return new OBJ_MISPAR_ISHI_SUG_CHISHUV();
        }
    }

    // Factory to create an object for the above class
    [OracleCustomTypeMappingAttribute("KDSADMIN.OBJ_MISPAR_ISHI_SUG_CHISHUV")]
    public class OBJ_MISPAR_ISHI_SUG_CHISHUVFactory : IOracleCustomTypeFactory
    {
