...
//                {
//                    if ((DayInstance.oOved.oMeafyeneyOved.IsMeafyenExist(51)) || (DayInstance.oOved.oMeafyeneyOved.IsMeafyenExist(61)))
//                    {
...
//                iZmanNesiaHaloch = -1;
//                iZmanNesiaChazor = -1;
//                if (DayInstance.oOved.oMeafyeneyOved.IsMeafyenExist(61)) // אם קיים מאפיין 61, לעובד מגיע זמן נסיעה משתנה
//                {
