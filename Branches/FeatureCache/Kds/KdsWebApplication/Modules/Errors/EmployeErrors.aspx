        ...
        <table class="FilterTable">
            <tr>
                ...
                <asp:UpdatePanel ID="upId" runat="server" RenderMode="Inline" UpdateMode="Conditional" >
                        <ContentTemplate> 
                            <asp:TextBox ID="txtId" runat="server" AutoComplete="Off" onchange="GetOvedNameById(0);" MaxLength="5" dir="rtl" onfocus="this.select();" TabIndex="7"  onkeydown="return ChangeKeyCode(event);"  ></asp:TextBox>                            
                ...
                <td style="width:200px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional"  >
                        <ContentTemplate> 
                            <asp:TextBox ID="txtName" runat="server" AutoComplete="Off"  onchange="GetOvedIdByName(0);" onfocus="this.select();" style="width:200px" TabIndex="8"  onkeydown="return ChangeKeyCode(event);"  ></asp:TextBox>
