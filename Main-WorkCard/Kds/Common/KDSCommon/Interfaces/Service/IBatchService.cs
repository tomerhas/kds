...
namespace KDSCommon.Interfaces.Service
{
    [ServiceContract]
    public interface IBatchService
    {
        ...
        [OperationContract]
        void ShinuyimVeShguimBatch(long lRequestNum, DateTime dTaarich, enCalcType TypeShguyim, BatchExecutionType ExecutionTypeShguim);
