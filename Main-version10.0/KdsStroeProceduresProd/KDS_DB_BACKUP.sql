...
PROCEDURE pro_get_meafyen_sidur_by_kod(P_Kod_Sidur in integer,
 ...
 PROCEDURE pro_get_kod_whithoutlist(p_Prefix in VARCHAR2 , whithOutList in VARCHAR2,   whithOutListMisSidur in VARCHAR2 ,  p_kod_element IN VARCHAR2 , p_Cur OUT CurType);
...
--P_STARTDATE:=  to_date('30/04/2015','dd/mm/yyyy');
 --P_ENDDATE:= to_date('30/04/2015','dd/mm/yyyy');
    ...
    OPEN p_cur FOR          
     with snifEg as(
      ...
      pivot as (  
       ...
       ,sidurim as(
             select Pkg_Reports.fn_get_makat_type(p.makat_nesia) makat_type, 
    ...
    egedToTavura as(
        select s.mispar_ishi,s.taarich,s.mispar_sidur,s.shat_hatchala_sidur
  ...
  */    
    ...
    select s.mispar_ishi, s.fullname, H.TEUR_HEVRA, z.TEUR_EZOR,s.isuk,  SA.TEUR_SNIF_AV,I.KOD_ISUK, I.TEUR_ISUK,
           ...
           S.LO_LETASHLUM,s.MAKAT_NESIA,s.SHAT_YETZIA,s.MISPAR_KNISA, 
            case when makat_type=5 then pkg_elements.getKmByMakatElement(s.makat_nesia,'true') else s.km end km, 
             s.snif_catalog snif_shayachut_peilut,s.nihul snif_tiful_peilut,
        ...
        WHERE a.seq=1 )    ,            
         SidurimRechevEgged as(
          ...
          select Pkg_Reports.fn_get_makat_type(p.makat_nesia) makat_type,
                  ...
                  p.oto_no,c.km, c.snif snif_catalog, c.nihul
