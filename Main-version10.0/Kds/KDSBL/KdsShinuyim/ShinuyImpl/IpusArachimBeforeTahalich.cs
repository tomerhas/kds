        ...
        private void IpusArachimBeforeTchilatTahalich(ShinuyInputData inputData)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < inputData.htEmployeeDetails.Count; i++)
                {
                    ...
                    if (oSidur.iLoLetashlum == 1 || (oSidur.iLoLetashlum == 0 && !CheckIdkunRashemet("PITZUL_HAFSAKA", oSidur.iMisparSidur, oSidur.dFullShatHatchala, inputData)))
                    {
                        ...
                        if (CheckIdkunRashemet("PITZUL_HAFSAKA", oSidur.iMisparSidur, oSidur.dFullShatHatchala, inputData))
                            DeleteIdkunRashemet("PITZUL_HAFSAKA", oSidur.iMisparSidur, oSidur.dFullShatHatchala, inputData);
                    }
