    ...
    public class ParametersManager : IParametersManager
    {
        ...
        private void SetParameters(clParametersDM cls, DateTime dCardDate, int iSugYom, DataTable dtParams)
        {
            ...
            try
            {
                ...
                //311
                sTmp = GetOneParam(311, dCardDate);
                cls.dParam311 = String.IsNullOrEmpty(sTmp) ? DateTime.MinValue : DateTime.Parse(sTmp);
                ...
                //315
                sTmp = GetOneParam(315, dCardDate);
                cls.dParam315 = String.IsNullOrEmpty(sTmp) ? DateTime.MinValue : DateTime.Parse(sTmp);


                //316
                sTmp = GetOneParam(316, dCardDate);
                cls.dParam316 = String.IsNullOrEmpty(sTmp) ? DateTime.MinValue : DateTime.Parse(sTmp);
                ...
                //319
                sTmp = GetOneParam(319, dCardDate);
                cls.dParam319 = String.IsNullOrEmpty(sTmp) ? DateTime.MinValue : DateTime.Parse(sTmp);
