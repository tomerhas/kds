<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Modules_Errors_EmployeErrors" Title="Untitled Page" Codebehind="EmployeErrors.aspx.cs" %>
            ...
            <tr>
                ...
                <td style="width:320px">
                    <asp:UpdatePanel ID="upSnif" runat="server" RenderMode="Inline" UpdateMode="Conditional"   >
                        <ContentTemplate>                         
                            <asp:TextBox ID="txtSnif" runat="server" AutoComplete="Off" onchange="CheckSnif();" TabIndex="2" dir="rtl" onfocus="this.select();" style="width:300px" ></asp:TextBox>
        ...
        <table class="FilterTable">
            <tr>
                ...
                <asp:UpdatePanel ID="upId" runat="server" RenderMode="Inline" UpdateMode="Conditional" >
                        <ContentTemplate> 
                            <asp:TextBox ID="txtId" runat="server" AutoComplete="Off" onchange="GetOvedNameById(0);" MaxLength="5" dir="rtl" onfocus="this.select();" TabIndex="7"  onfocusin="DisplayError();"   onkeydown="return ChangeKeyCode(event);"  ></asp:TextBox>                            
                ...
                <td style="width:200px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional"  >
                        <ContentTemplate> 
                            <asp:TextBox ID="txtName" runat="server" AutoComplete="Off"  onchange="GetOvedIdByName(0);" onfocusin="this.select();DisplayError();"   style="width:200px" TabIndex="8"  onkeydown="return ChangeKeyCode(event);"  ></asp:TextBox>
