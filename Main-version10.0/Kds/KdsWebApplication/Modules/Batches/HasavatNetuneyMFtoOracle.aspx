<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  AutoEventWireup="true" Inherits="Modules_Batches_HasavatNetuneyMFtoOracle" Title="הרצת הסבת נתונים לאורקל" Codebehind="HasavatNetuneyMFtoOracle.aspx.cs" %>
      ...
      <tr>
        <td align="left"> 
            <asp:UpdatePanel ID="upButton" runat="server"  UpdateMode="Conditional">
                <ContentTemplate>
                 <asp:Button Text="הפעל הסבה" ID="btnRun" runat="server" Width="134px" CssClass="ImgButtonSearch" 
...
<asp:UpdatePanel ID="upMessage" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     function RunHasava(iRequestId) {
         wsBatch.InsetRecordsToHistory(iRequestId); //,RunErrorsSucceeded );
     }
