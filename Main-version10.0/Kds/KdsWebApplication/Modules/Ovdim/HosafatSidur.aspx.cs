...
public partial class Modules_Ovdim_HosafatSidur : KdsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtShatHatchala.Attributes.Add("onfocus", "this.className='WCSidurTxtF';");
        txtShatHatchala.Attributes.Add("onblur", "this.className='WCPilutTxt';");

        txtShatGmar.Attributes.Add("onfocus", "this.className='WCSidurTxtF';");
        txtShatGmar.Attributes.Add("onblur", "this.className='WCPilutTxt';");
        ...
        if (!Page.IsPostBack)
        {
          //  btnMapa.Style["disabled"] = "disabled";
            ...
            sugSidur.Value = "1";
            hidMenahelBankShaot.Value =  LoginUser.IsMenahelBankShaot(LoginUser).ToString();
    ...
    protected void grdPeiluyot_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if ( e.Row.RowType == DataControlRowType.DataRow || e.Row.RowType == DataControlRowType.Separator)
            {
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.SHAT_YETZIA].Controls[1]).Attributes.Add("onfocus", "this.className='WCPilutTxtF';");
                ((TextBox)e.Row.Cells[(int)enPeilut.SHAT_YETZIA].Controls[1]).Attributes.Add("onblur", "this.className='WCPilutTxt';");
                ((TextBox)e.Row.Cells[(int)enPeilut.KISUY_TOR].Controls[1]).Attributes.Add("onfocus", "this.className='WCSidurTxtF';");
                ((TextBox)e.Row.Cells[(int)enPeilut.KISUY_TOR].Controls[1]).Attributes.Add("onblur", "this.className='WCPilutTxt';");
            ...
            //        Rechev.ToolTip = e.Row.Cells[(int)enPeilut.hidMisRishuy].Text;
               ...
               // ((AjaxControlToolkit.ValidatorCalloutExtender)e.Row.Cells[(int)enPeilut.MISPAR_RECHEV].FindControl("exvMakat")).BehaviorID = e.Row.ClientID + "_vldExvldMakat";
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.MAKAT].FindControl("txtMakat")).Attributes.Add("onFocus ", "this.className='WCSidurTxtF';onSadeFocus(" + e.Row.ClientID + "_txtMakat)");
                ((TextBox)e.Row.Cells[(int)enPeilut.MAKAT].FindControl("txtMakat")).Attributes.Add("onblur ", "this.className='WCPilutTxt';");
                ...
                ((TextBox)e.Row.Cells[(int)enPeilut.DAKOT_BAFOAL].FindControl("txtDakotBafoal")).Attributes.Add("onFocus ", "this.className='WCSidurTxtF';onSadeFocus(" + e.Row.ClientID + "_txtDakotBafoal)");
                ((TextBox)e.Row.Cells[(int)enPeilut.DAKOT_BAFOAL].FindControl("txtDakotBafoal")).Attributes.Add("onblur ", "this.className='WCPilutTxt';");
