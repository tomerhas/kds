<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Modules_Ovdim_NetuneyOved" Codebehind="NetuneyOved.aspx.cs" %>
        ...
        <tr>
            ...
            <td dir="rtl">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server"  RenderMode="Inline">
                        <ContentTemplate> 
                            <asp:TextBox ID="txtEmpId" runat="server" AutoComplete="Off" dir="rtl" onfocus="this.select();" onfocusin="DisplayError();"   onchange="GetOvedNameById();"
            ...
            <td class="style2">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                       <ContentTemplate> 
                            <asp:TextBox ID="txtName" runat="server" onfocus="this.select();" onchange="GetOvedIdByName();" onfocusin="DisplayError();"   AutoComplete="Off" style="width:160px" EnableViewState="true" ></asp:TextBox>
