      ...
      //  public int SugYom { get; set; }
        ...
        internal void CalcRechivim()
        {
            ...
            //{
                ...
                //נוכחות לפרמיה – משק מוסכים (רכיב 211) -נוכחות לפרמיה – משק אחסנה (רכיב 212) -2
             //   CalcRechiv211_212_2();
        ...
        private void CalcRechiv1()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich, "", ex);
                throw (exec);
            }
        }
        ...
        private void UpdateRechiv1()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich, "CalcDay--> UpdateRechiv1", ex);  
                throw (exec);
            }
        }
        ...
        private void CalcRechiv2()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNehigaChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv3()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNihulTnuaChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv4()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotTafkidChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv5()
        {
            ...
            try
            {
                ...
                //   { 
                //       if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue  == 40)
                //        {
                //           oSidur.CalcRechiv5();
                ...
                //            }
                //        }
                //       else if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 41)
                //       {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ShaotHeadrut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv7()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotZikuyChofesh.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv10()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotTamritzTafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv12()
        {
            ...
            try
            {
                ...
                if (fSumDakotRechiv > 0)
                {
                    ...
                    {
                        if (objOved.SugYom == enDay.Shabat.GetHashCode() || clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                            fTempZ = 0;
                        else fTempZ = 240;
                     }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotTosefetMeshek.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv13()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifMeshaleach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv14()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifSadran.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv15()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifPakach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv16()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifKupai.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        ...
        private void CalcRechiv17()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifRakaz.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        ...
        private void CalcRechiv18()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNochehutBefoal.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv19_20_21()
        {
                           ...
                           // fTempX = fTempX - oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.DakotZikuyChofesh);
                            ...
                            if (fMichsaYomit>0 && fDakotNochechut>0)
                            {
                                ...
                                if (fTempX > fMichsaYomit)
                                {
                                    ...
                                    //if ((objOved.objMeafyeneyOved.GetMeafyen(74).Value != "1") || (objOved.objMeafyeneyOved.GetMeafyen(74).Value == "1" && objOved.objPirteyOved.iIsuk == clGeneral.enIsukOved.Poked.GetHashCode() && oCalcBL.CheckYomShishi(objOved.SugYom)))
                                    //{
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNosafotTafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv147()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzNosafotTafkidChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv160()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzNosafotTnuaChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv22()
        {
                                ...
                                if (fMichsaYomit126 > 0 && fNochechtLeTashlum>0)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        //{
                                            ...
                                            //    if (oCalcBL.CheckSugSidur(objOved, clGeneral.enMeafyen.SugAvoda.GetHashCode(), enSugAvoda.Kupai.GetHashCode(), iSugSidur))
                                            //    {
                                            //        sum = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_SIDUR"].Compute("SUM(ERECH_RECHIV)", "KOD_RECHIV=" + clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode().ToString() + " and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime') AND MISPAR_SIDUR=" + drSidurim[i]["mispar_sidur"].ToString()));
                                            //        fTempX += sum;
                                            //    }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KamutGmulChisachon.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv23()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotSikun.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv26_2()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv27()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaBetochMichsa.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv28()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaVisa.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv29()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaVisaShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv30_2()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaYomit.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv32()
        {
            ...
            try
            {
                ...
                if (objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek1.GetHashCode() || objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved6DaysInWeek1.GetHashCode())
                {
                    //if (objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30 && objOved.SugYom == enSugYom.Bchirot.GetHashCode())
                    //{
                    //    fSumDakotRechiv = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich); 
                    //}
                    //else
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotRegilot.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv35()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNehigaShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv36()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNihulTnuaShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv37()
        {
            ...
            try
            {
                ...
                //{
                    ...
                    if (fSumDakotRechiv > 0)
                    {
                        ...
                        fSumDakotRechiv = fSumDakotRechiv + oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.HashlamaBetafkid); //oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.ZmanHashlama.GetHashCode(), objOved.Taarich);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotTafkidShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv38()
        {
            ...
            try
            {
                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                {
                    if (objOved.objMeafyeneyOved.GetMeafyen(50).Value == "1")
                    {
                        oSidur.CalcRechiv38();
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachEshelBoker.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv40()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachEshelErev.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv42()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachEshelTzaharayim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv44()
        {
            ...
            try
            {
                ...
                if ((objOved.Taarich - objOved.dTchilatAvoda).Days > (5 * 365))
                {
                    if (objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.Sachir12.GetHashCode() || objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.OvedChadshKavua.GetHashCode() ||
                        objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.SachirKavua.GetHashCode() || (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Friends.GetHashCode()))
                    {
                        if (objOved.objMeafyeneyOved.GetMeafyen(60).IntValue == 2)
                        {
                            if (objOved.objPirteyOved.iDirug != 85 || objOved.objPirteyOved.iDarga != 30)
                            {
                                if (!clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KamutGmulChisachonNosafot.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv39_41_43()
        {
            ...
            try
            {
                ...
                if (fSumDakotRechiv > 0)
                {
                    addRowToTable(clGeneral.enRechivim.SachEshelBokerMevkrim.GetHashCode(), 1);
                }
                ...
                if (fSumDakotRechiv > 0)
                {
                    addRowToTable(clGeneral.enRechivim.SachEshelErevMevkrim.GetHashCode(), 1);
                }
                ...
                if (fSumDakotRechiv > 0)
                {
                    addRowToTable(clGeneral.enRechivim.SachEshelTzaharayimMevakrim.GetHashCode(), 1);
                }
            }
            catch (Exception ex)
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachEshelTzaharayimMevakrim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        //    catch (Exception ex)
        //    {
        //        var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KamutGmulChisachonMeyuchad.GetHashCode(), objOved.Taarich, "",ex);
        //        throw (exec);
        //    }
        //}
        ...
        private void CalcRechiv47()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachLina.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv48()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachLinaKfula.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv49()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachPitzul.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv50()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachPitzulKaful.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv52()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotLepremia.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv53()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanHamaratShaotShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv54()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanLailaEgged.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv55()
        {
            ...
            try
            {
                     ...
                     (objOved.objPirteyOved.iIsuk == 122 || objOved.objPirteyOved.iIsuk == 123 || objOved.objPirteyOved.iIsuk == 124 || objOved.objPirteyOved.iIsuk == 127)))
                {
                    ...
                    else
                    {
                        ...
                        if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() && CheckSugMishmeret() == enSugMishmeret.Liyla.GetHashCode() &&
                         (objOved.objPirteyOved.iIsuk == 122 || objOved.objPirteyOved.iIsuk == 123 || objOved.objPirteyOved.iIsuk == 124 || objOved.objPirteyOved.iIsuk == 127))
                        {
                            fSumDakotRechiv = fTempX;
                        }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanLailaChok.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv56()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomEvel.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv57()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomHadracha.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv59()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomLeloDivuach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        {
            float fErechRechiv,  fMichsaYomit, fDakotNochechut;
            ...
            {               
                ...
                if (fMichsaYomit > 0)
                {
                    fErechRechiv = CalcHeadruyot(clGeneral.enRechivim.YomMachla.GetHashCode());
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachla.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }     
        }
        ...
        private void CalcRechiv61()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalaBoded.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv62()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMiluim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv63()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomAvodaBechul.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv64()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomTeuna.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv65()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomShmiratHerayon.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv66()
        {
           ...
           // clPirteyOved oEzerPratim; 
            try
            {
                ...
                if (oCalcBL.GetSugYomLemichsa(objOved, objOved.Taarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue) == enSugYom.ErevYomHatsmaut.GetHashCode()
                  && objOved.objMeafyeneyOved.GetMeafyen(63).Value != "" && objOved.objMeafyeneyOved.GetMeafyen(63).Value  != "0" && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1)
                ...
                if(!bAzmautWithMeafyen63)
                {
                    ...
                    if (rowSidur.Length == 0)
                    {
                        ...
                        //{
                            ...
                            if (!(rowSidur.Length > 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1))
                            {
                                fErechRechiv = 0;
                                if (fMichsaYomit > 0)
                                {
                                ...
                                if (fMichsaYomit > 0 && fDakotNochehut == 0 && objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is not null").Length == 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1)
                                { fErechRechiv = 1; }
                                //ד
                                ...
                                if (fMichsaYomit > 0 && fDakotNochehut == 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1 && fMiluimBoded == float.Parse("0.5"))
                                     ...
                                     && (objOved.objPirteyOved.iZmanMutamut > 0 && (objOved.objPirteyOved.iMutamut == 1 ||  objOved.objPirteyOved.iMutamut == 5 || objOved.objPirteyOved.iMutamut == 7)))
                                {
                                    ...
                                    {
                                        if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1) // && fDakotNochehut < objOved.objPirteyOved.iZmanMutamut)
                                        {
                                            fErechRechiv = ((fMichsaYomit  - fDakotNochehut) / fMichsaYomit);
                                        }
                                ...
                                {
                                    if (fDakotNochehut < fMichsaYomit && fDakotNochehut > 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1)
                                    {
                               ...
                               // oEzerPratim =  objOved.PirteyOved.First(Pratim => (Pratim.iMutamut == 4 || Pratim.iMutamut == 5 || Pratim.iMutamut == 8));
                                ...
                                {
                                    if (fMichsaYomit > 0 && fDakotNochehut == 0 && !HaveRechivimInDay(objOved.Taarich, "60,61,71,70,69,65,280,68,56,64,67,62,266,292") && objOved.objMatzavOved.iKod_Headrut == 0)
                                        fErechRechiv = 1;
                                    else 
                                        fErechRechiv = (fMichsaYomit - objOved.objPirteyOved.iZmanMutamut) / fMichsaYomit;
                                 ...
                                 /**     זמנית 18/09/2014    if ((objOved.objPirteyOved.iSibotMutamut == 2 || objOved.objPirteyOved.iSibotMutamut == 3 || objOved.objPirteyOved.iSibotMutamut == 22) && objOved.objPirteyOved.iIshurKeren > 0)
                                    {
                                        ...
                                        if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1 && fMichsaYomit > 0 && fDakotNochehut < objOved.objPirteyOved.iZmanMutamut && fErech60 == 0)
                                            fErechRechiv += ((objOved.objPirteyOved.iZmanMutamut - fDakotNochehut) / fMichsaYomit);
                                    }**/
                                }
                                ...
                                if (objOved.objMeafyeneyOved.GetMeafyen(83).IntValue == 1 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1)
                                {
                                    sRechivim = clGeneral.enRechivim.YomHadracha.GetHashCode().ToString() + "," + clGeneral.enRechivim.YomMachalatHorim.GetHashCode().ToString() +
                                          ...
                                          "," + clGeneral.enRechivim.YomMachalatBenZug.GetHashCode().ToString() + "," + clGeneral.enRechivim.YomAvodaBechul.GetHashCode().ToString() +
                                           ...
                                           clGeneral.enRechivim.YomMachalaMisradHaBitachon.GetHashCode().ToString();
                                    ...
                                    if (fMichsaYomit > 0 && fMichsaYomit > fDakotNochehut && fDakotNochehut > 0 ) //|| (objOved.SugYom == enSugYom.CholHamoedPesach.GetHashCode() || objOved.SugYom == enSugYom.CholHamoedSukot.GetHashCode())))
                                    {
                                ...
                                if (!bMutaam && bMaamadChange && fErechRechiv > 0 && fErechRechiv < 1 && fDakotNochehut > 0 &&
                                    !(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30) && (objOved.objMeafyeneyOved.GetMeafyen(33).ErechIshi != "1") )
                                        bChangeTo67 = true;
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomHeadrut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv67()
        {
          ...
          // int matzav=0;
            try
            {
                ...
                if (oCalcBL.GetSugYomLemichsa(objOved, objOved.Taarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue) == enSugYom.ErevYomHatsmaut.GetHashCode()
                  && objOved.objMeafyeneyOved.GetMeafyen(63).Value  != "" && objOved.objMeafyeneyOved.GetMeafyen(63).Value != "0" && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0)
                    bAzmautWithMeafyen63 = true;
                ...
                if(!bAzmautWithMeafyen63)
                {
                     ...
                     //{
                         rowSidur = objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur=99841 and Hashlama_Leyom=1");
                         if (!(rowSidur.Length > 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0))
                         {
                             fErechRechiv = 0;
                             if (fMichsaYomit > 0)
                             {
                             ...
                             //א
                             fDakotNochehut = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich);
                             if (fMichsaYomit > 0 && fDakotNochehut == 0 && objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is not null").Length == 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0)
                             { fErechRechiv = 1; }

                             //ב
                             fMiluimBoded = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.YomMiluimChelki.GetHashCode(), objOved.Taarich);
                             if (fMichsaYomit > 0 && fDakotNochehut == 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0 && fMiluimBoded == float.Parse("0.5"))
                                     ...
                                     && fMichsaYomit > 0 && (objOved.objPirteyOved.iZmanMutamut > 0 && (objOved.objPirteyOved.iMutamut == 1 || objOved.objPirteyOved.iMutamut == 5 || objOved.objPirteyOved.iMutamut == 7)) ) //&& !objOved.bMeafyen85YomMeyuchad)
                             {
                                      ...
                                      ((objOved.objPirteyOved.iZmanMutamut > 0 && (objOved.objPirteyOved.iMutamut == 1 || objOved.objPirteyOved.iMutamut == 5 || objOved.objPirteyOved.iMutamut == 7)) && objOved.Taarich < objOved.objParameters.dChodeshTakanonSoziali)))
                                 {
                                     ...
                                     if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0 && rowSidur.Length == 0)
                                     {
                                         fErechRechiv = (fMichsaYomit - fDakotNochehut) / fMichsaYomit;
                                     }
                                     ...
                                     //}
                                          ...
                                          (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Friends.GetHashCode() &&
                                           ...
                                           (objOved.objPirteyOved.iZmanMutamut > 0 && (objOved.objPirteyOved.iMutamut == 1 || objOved.objPirteyOved.iMutamut == 5 || objOved.objPirteyOved.iMutamut == 7))))
                                 {
                                     if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0 && fDakotNochehut>0  && fDakotNochehut < objOved.objPirteyOved.iZmanMutamut)
                                 ...
                                 if (HaveRechivimInDay(objOved.Taarich, "60,61,65,69,70,71,68,292") && fErechRechiv == 1)
                                 {
                                     fErechRechiv = 0;
                                 }
                                 //היעדרות יום שלם מהעבודה ללא סיבה + לעובד יש אישור חופש: 4
                                 if (fMichsaYomit>0 && fDakotNochehut==0 && !HaveRechivimInDay(objOved.Taarich, "60,61,71,70,69,65,280,68,56,64,67,62,266,292") && objOved.objMatzavOved.iKod_Headrut == 1)
                                     fErechRechiv = objOved.objPirteyOved.iZmanMutamut / fMichsaYomit;
                             ...
                             {
                                 if (fDakotNochehut < fMichsaYomit && fDakotNochehut > 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0)
                                 {
                                     if (!HaveRechivimInDay(objOved.Taarich))
                                         fErechRechiv = (fMichsaYomit - fDakotNochehut) / fMichsaYomit;
                                 }
                      ...
                      /**     זמנית 18/09/2014   if (objOved.Taarich >= objOved.objParameters.dChodeshTakanonSoziali && objOved.objPirteyOved.iZmanMutamut > 0 &&
                             ...
                             ////    if (fErech60 !=1 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0 && fMichsaYomit>0 && fDakotNochehut < objOved.objPirteyOved.iZmanMutamut)
                             ////        fErechRechiv = (objOved.objPirteyOved.iZmanMutamut - fDakotNochehut) / fMichsaYomit;
                             ////    else fErechRechiv = 0;
                             ////}
                             ...
                             //חישוב עבור עובדים גלובליים:
                             if (objOved.objMeafyeneyOved.GetMeafyen(83).IntValue == 1 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0)
                             {
                                 sRechivim = clGeneral.enRechivim.YomHadracha.GetHashCode().ToString() + "," + clGeneral.enRechivim.YomMachalatHorim.GetHashCode().ToString() +
                                       "," + clGeneral.enRechivim.YomMachalaYeled.GetHashCode().ToString() + "," + clGeneral.enRechivim.YomShmiratHerayon.GetHashCode().ToString() +
                                       "," + clGeneral.enRechivim.YomMachalatBenZug.GetHashCode().ToString() + "," + clGeneral.enRechivim.YomAvodaBechul.GetHashCode().ToString() +
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomChofesh.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv68()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomTipatChalav.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv69()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalatBenZug.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv70()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalatHorim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv71()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalaYeled.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv280()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalatYeledHadHori.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv291()
        {
            ...
            try
            {
                ...
                fErechRechiv = 0;
                if (objOved.Taarich >= objOved.objParameters.dTaarichHafalatNochechutBeyomMiluim && fMichsa > 0)
                {
                    fDakotNocheut = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich);
        ...
        private void CalcRechiv292()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMachalaMisradHaBitachon.GetHashCode(), objOved.Taarich, "", ex);
                throw (exec);
        ...
        private void CalcRechiv72()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomKursHasavaLekav.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private float CalcHeadruyot(int iKodRechiv)
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> CalcHeadruyot", ex);     
                throw (exec);
            }
        }
        ...
        private void CalcRechiv75()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YemeyNochehutLeoved.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
           ...
           // int iSugYom;
            try
            {
             ...
             //   iSugYom = SugYom;
                ...
                {
                    if (((objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek1.GetHashCode() || objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved6DaysInWeek1.GetHashCode()) && (objOved.objMeafyeneyOved.GetMeafyen(32).Value != "1")) ||
                        objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek2.GetHashCode() && fMichsaYomit == 0 && oCalcBL.CheckYomShishi(objOved.SugYom))
                    {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Nosafot125.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private float CalcDayRechiv76(float fMichsaYomit, DateTime dTaarich)
        {
            ...
            try
            {
               ...
               // fDakotNochehut = fDakotNochehut - SumNochechutMeyuchdim;
                ...
                if (fMichsaYomit == 0 && oCalcBL.GetSugYomLemichsa(objOved, dTaarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue) == enSugYom.Shishi.GetHashCode())
                {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> CalcDayRechiv76", ex);     
                throw (exec);
            }
        }
        ...
        private void CalcRechiv77()
        {
          ...
          //  int iSugYom;
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Nosafot150.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private float CalcDayRechiv77(float fMichsaYomit, DateTime dTaarich)
        {
          ...
          //  float SumNochechutMeyuchdim;
            ...
            try
            {
             ...
             //   fDakotNochehut = fDakotNochehut - SumNochechutMeyuchdim;
                if (fMichsaYomit > 0 && fDakotNochehut > 0 && objOved.objMeafyeneyOved.GetMeafyen(32).Value != "1")
                {
                ...
                else if (fMichsaYomit > 0 && fDakotNochehut > 0 && objOved.objMeafyeneyOved.GetMeafyen(32).Value == "1")
                {
                    if (fDakotNochehut > fMichsaYomit)
                    {
                ...
                if (fMichsaYomit == 0 && fDakotNochehut > 0 && oCalcBL.GetSugYomLemichsa(objOved, dTaarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue) == enSugYom.Shishi.GetHashCode() && objOved.objMeafyeneyOved.GetMeafyen(32).Value != "1")
                {
                    fErech = fDakotNochehut -fDakotNosafotSidurey100 - 240;
                    fErech = Math.Max(0, fErech);
                }
                else if (fMichsaYomit == 0 && fDakotNochehut > 0 && oCalcBL.GetSugYomLemichsa(objOved, dTaarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue) == enSugYom.Shishi.GetHashCode() && objOved.objMeafyeneyOved.GetMeafyen(32).Value == "1")
                {
                ...
                if (objOved.objPirteyOved.iIsuk == 122 || objOved.objPirteyOved.iIsuk == 123 || objOved.objPirteyOved.iIsuk == 124 || objOved.objPirteyOved.iIsuk == 127)
                {
                    if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode())
                    {
                        if (CheckSugMishmeret() == enSugMishmeret.Liyla.GetHashCode())
                        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> CalcDayRechiv77", ex);    
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv78()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NosafotShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv80()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzTafkidChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv81()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLamichsaShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv85()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachTosefetRetzifut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv86()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzDakotHatchalaGmar.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv88()
        {
            ...
            try
            {
                ...
                if (drSidurim.Length == 0)
                {
                    ...
                    if (objOved.SugYom < enSugYom.Shishi.GetHashCode())
                    {
                        fMichsaYomit = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.MichsaYomitMechushevet.GetHashCode(), objOved.Taarich);
                        ...
                        if (fMichsaYomit > 0)
                        {
                            if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                            {
                                ...
                                if (objOved.objPirteyOved.iIsuk < 500 || objOved.objPirteyOved.iIsuk >= 600)// ((objOved.objPirteyOved.iIsuk.ToString()).Substring(0, 1) != "5")
                                {
                                    ...
                                    if (objOved.objMeafyeneyOved.GetMeafyen(30).IntValue == 1)
                                    {
                                        oSidur.CalcRechiv88();
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanAruchatTzaraim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv89()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzBevisa.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv90()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzOvedMutam.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv100()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Shaot100Letashlum.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        private void CalcRechiv91()
        {
            ...
            try
            {
                ...
                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                {
                    if (objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek2.GetHashCode())
                    {
                        ...
                        if (fMichsaYomit > 0 || (objOved.objMeafyeneyOved.GetMeafyen(92).IntValue>0 && oCalcBL.CheckYomShishi(objOved.SugYom)))
                        {
                            fDakotRechiv = CalcDayRechiv76(fMichsaYomit, objOved.Taarich);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Shaot25.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv92()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Shaot50.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv93()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanHalbasha.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv94()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanHashlama.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv95()
        {
                            ...
                            || ((objOved.objPirteyOved.iIsuk != 183 && objOved.objPirteyOved.iIsuk != 184 && objOved.objPirteyOved.iIsuk != 193) && (fSachNahagut + fSachNihulTnua) > objOved.objParameters.iMinDakotNehigaVetnuaLezakautNesiot || fSachTafkid >= objOved.objParameters.iMinDakotLezakautNesiot))
                {
                    ...
                    if (rowSidurim.Length > 0)
                    {
                        ...
                        if (rowBitulZmanNesiot.Length > 0)
                        {
                            ...
                            if (rowMezakeNesia.Length > 0)
                            {
                                ...
                                if ((rowMezakeNesia[0]["mispar_sidur"].ToString() == RowKodem["mispar_sidur"].ToString()) && (rowMezakeNesia[0]["shat_hatchala_sidur"].ToString() == RowKodem["shat_hatchala_sidur"].ToString()))
                                {
                                    ...
                                    if (bLogNahag)
                                    {
                                        ...
                                        fNesiotTchilatYom = fNesiotTchilatYom - GetDakotHafchataMizmanNesia();
                                    }
                            ...
                            {
                                if (bLogNahag)
                                    fNesiotTchilatYom = int.Parse(rowBitulZmanNesiot[0]["Zman_Nesia_Haloch"].ToString()) - GetDakotHafchataMizmanNesia();
                                else
                        ...
                        if (rowBitulZmanNesiot.Length > 0)
                        {
                            ...
                            if (rowMezakeNesia.Length > 0)
                            {
                                ...
                                if ((rowMezakeNesia[rowMezakeNesia.Length - 1]["mispar_sidur"].ToString() == RowNext["mispar_sidur"].ToString()) && (rowMezakeNesia[rowMezakeNesia.Length -1]["shat_hatchala_sidur"].ToString() == RowNext["shat_hatchala_sidur"].ToString()))
                                {
                                    ...
                                    if (bLogNahag)
                                        fNesiotSofYom = fNesiotSofYom - GetDakotHafchataMizmanNesia();
                                    if (fNesiotSofYom < 0)
                                    {
                                        fNesiotSofYom = 0;
                                    }
                            ...
                            {
                                if (bLogNahag)
                                    fNesiotSofYom = int.Parse(rowBitulZmanNesiot[0]["Zman_Nesia_Hazor"].ToString()) - GetDakotHafchataMizmanNesia();
                                else
                        ...
                        //}
                        //else
                        if (objOved.Taarich.DayOfWeek.GetHashCode() + 1 == enDay.Shabat.GetHashCode() || clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, iSugYom, objOved.Taarich))
                        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanNesia.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }

        private int GetDakotHafchataMizmanNesia()
        {
            try
            {
                int dakot = 45;
                if (objOved.Taarich >= objOved.objParameters.dTaarichHafalatHafchataZmanNesia)
                    if (!String.IsNullOrEmpty(objOved.objMeafyeneyOved.GetMeafyen(51).Value))
                        dakot = objOved.objParameters.iDakotHafchataZmanNesia;
        ...
        private void CalcRechiv96()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanRetzifutNehiga.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv97()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanRetzifutTafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv109()
        {
            ...
            try
            {
                ...
                if (objOved.SugYom == enSugYom.ErevYomHatsmaut.GetHashCode() && (objOved.objMeafyeneyOved.GetMeafyen(63).Value != "" && objOved.objMeafyeneyOved.GetMeafyen(63).Value != "0"))
                {
                    fSumDakotRechiv = 1;
                }
                ...
                if (objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek1.GetHashCode())
                {
                    drRowSidurim = null;
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YemeyAvoda.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv293()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YemeyNochechut.GetHashCode(), objOved.Taarich, "", ex);
                throw (exec);
        ...
        {
            float fDakotNochehut, fMichsaMechushevet, fYomMachala, fYomMachaltHorim, fYomMachalaBoded, fYomMachalaBenZug,fMachalatMisradBitachon;
            ...
            try
            {
                ...
                fMachalatMisradBitachon = oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.YomMachalaMisradHaBitachon); 
                ...
                if (fDakotNochehut > 0 && fMichsaMechushevet > 0 && fYomMachala == 0 && fYomMachalaBoded == 0
                    ...
                    && fYomKursHasavaLekav == 0 && fYomMachalaBenZug == 0 && fYomTeuna == 0 && fYomMachaltHorim == 0 && fMachalatMisradBitachon ==0)
                {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YemeyAvodaLeloMeyuchadim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv125()
        {
            ...
            try
            {
                ...
                if (objOved.objMeafyeneyOved.GetMeafyen(42).Value == "1" &&  objOved.SugYom < enSugYom.Shishi.GetHashCode())
                {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MishmeretShniaBameshek.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        public void CalcRechiv126(DateTime dTaarich)
        {
           ...
           // bool flag = false;
            ...
            try
            {
                ...
                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                {
                    iMeafyen1 = int.Parse(objOved.objMeafyeneyOved.GetMeafyen(1).Value);
                   ...
                   // if (int.Parse(objOved.objMeafyeneyOved.GetMeafyen(1).Value) != 22 && int.Parse(objOved.objMeafyeneyOved.GetMeafyen(1).Value) != 23 && int.Parse(objOved.objMeafyeneyOved.GetMeafyen(1).Value) != 71 && int.Parse(objOved.objMeafyeneyOved.GetMeafyen(1).Value) != 72)
                    {
                        if (objOved.objPirteyOved.iGil == enKodGil.enKashish.GetHashCode())
                        {
                            ...
                            else if (objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved6DaysInWeek1.GetHashCode() || objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved6DaysInWeek2.GetHashCode())
                            {
                    ...
                    if (objOved.objMeafyeneyOved.GetMeafyen(47).Value == "1")
                    { fErechRechiv = fErechRechiv - 60; }
                    ...
                    if (objOved.objPirteyOved.iIsuk == 122 || objOved.objPirteyOved.iIsuk == 123 || objOved.objPirteyOved.iIsuk == 124 || objOved.objPirteyOved.iIsuk == 127)
                    {
                        if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode())
                        {
                            ...
                            {
                                if (iSugMishmeret == enSugMishmeret.Boker.GetHashCode())
                                {
                                    fErechRechiv = objOved.objParameters.iDakotMafileyMachshevColBoker;
                                }
                                else if (iSugMishmeret == enSugMishmeret.Tzaharim.GetHashCode())
                                {
                                    fErechRechiv = objOved.objParameters.iDakotMafileyMachshevColTzaharim;
                                }
                                else if (iSugMishmeret == enSugMishmeret.Liyla.GetHashCode())
                                {
                            ...
                            {
                                if (iSugMishmeret == enSugMishmeret.Boker.GetHashCode() || iSugMishmeret == enSugMishmeret.Tzaharim.GetHashCode())
                                {
                    ...
                    if (objOved.objMeafyeneyOved.GetMeafyen(91).Value.Length > 0)
                    {
                        if (int.Parse(objOved.objMeafyeneyOved.GetMeafyen(91).Value) > 0)
                        {
                            fErechRechiv = Math.Min(fErechRechiv, int.Parse(objOved.objMeafyeneyOved.GetMeafyen(91).Value));
                        }
                    }

                    if ((dTaarich.DayOfWeek.GetHashCode() + 1) == enDay.Shabat.GetHashCode())
                    { fErechRechiv = 0; }
                    else if ((dTaarich.DayOfWeek.GetHashCode() + 1) == enDay.Shishi.GetHashCode() && !CheckShishiMuchlaf(iSugYom, dTaarich) && (objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek1.GetHashCode() || objOved.objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved5DaysInWeek2.GetHashCode()))
                    { fErechRechiv = 0; }

                }
                else if (objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30 && iSugYom < enSugYom.Shishi.GetHashCode())
                {
                    if (fErechRechiv > 420)
                    {
                        int iMinuts = 0;
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichsaYomitMechushevet.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv128()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanGrirot.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv129()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifTnua.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv131()
        {
            ...
            try
            {
                ...
                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                {
                    ...
                    if (objOved.SugYom >= enSugYom.Shishi.GetHashCode() && objOved.SugYom < enSugYom.Shabat.GetHashCode())
                    {
                        fDakotNocheutGmar = 0;
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ShaotShabat100.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv132()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ChofeshZchut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv133()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.PremyaRegila.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void UpdateRechiv133()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.PremyaRegila.GetHashCode(), objOved.Taarich, "CalcDay--> UpdateRechiv133", ex);    
                throw (exec);
            }
        }
        ...
        private void CalcRechiv134()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.PremyaNamlak.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void UpdateRechiv134()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.PremyaNamlak.GetHashCode(), objOved.Taarich, "CalcDay--> UpdateRechiv134", ex);    
                throw (exec);
            }
        }
        ...
        private void CalcRechiv135()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaTafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv136()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaShivuk.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv137()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaBniaPeruk.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv138()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaYeshivatTzevet.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv139()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaYamimArukim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv140()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaMeavteach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv141()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzKaytanaMatzil.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv142()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzNochehut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv143()
        {
            ...
            try
            {
                ...
                if ((objOved.objMeafyeneyOved.GetMeafyen(14).FloatValue <= 0) && objOved.objMeafyeneyOved.GetMeafyen(12).IntValue > 0)
                {
                    ...
                    iSugYom = DateHelper.GetSugYom(objOved.oGeneralData.dtYamimMeyuchadim, objOved.Taarich, objOved.oGeneralData.dtSugeyYamimMeyuchadim);//, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue);
                    if ((iSugYom == enSugYom.CholHamoedPesach.GetHashCode() || iSugYom == enSugYom.CholHamoedSukot.GetHashCode() ||
                            iSugYom == enSugYom.ErevRoshHashna.GetHashCode() || iSugYom == enSugYom.ErevYomKipur.GetHashCode() ||
                            iSugYom == enSugYom.ErevSukot.GetHashCode() || iSugYom == enSugYom.ErevSimchatTora.GetHashCode() ||
                            iSugYom == enSugYom.ErevPesach.GetHashCode() || iSugYom == enSugYom.ErevPesachSheni.GetHashCode() ||
                            iSugYom == enSugYom.ErevShavuot.GetHashCode())
                        && objOved.objMeafyeneyOved.GetMeafyen(85).IntValue == 1 && fDakotNochehut == 0 && fMichsaYomit > 0 && bPutar)
                    {
                        bLechishuv = true;
                    }
                    if (iSugYom == enSugYom.ErevYomHatsmaut.GetHashCode() && objOved.objMeafyeneyOved.GetMeafyen(63).Value.Length > 0)
                    {
                        bLechishuv = true;
                    }
                    if (objOved.Taarich.Day >= 24 && fMichsaYomit > 0)
                    {
                        drs = objOved._dsChishuv.Tables["CHISHUV_YOM"].Select("KOD_RECHIV IN (60,61,70,71,69,65,64,56,292) and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')");
                        if (drs.Length>0)
                            bLechishuv = true;
                    }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichsatShaotNosafotTafkidChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        private void CalcRechiv145()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzVaadOvdim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv146()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.Nosafot100.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        private void SetSidureyVaadOvdim()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "", ex);
                throw (exec);
            }
        }
        ...
        private void CalcKizuzRechiv(int iKodRechiv)
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", iKodRechiv, objOved.Taarich, "CalcDay--> CalcKizuzRechiv", ex);    
                throw (exec);
            }
            finally
            {
        ...
        private void CalcRechiv149()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HashlamaAlCheshbonPremia.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        //    catch (Exception ex)
        //    {
        //        var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLemichsaPakach.GetHashCode(), objOved.Taarich, "",ex);
        //        throw (exec);
        //    }
        //}
        ...
        //    catch (Exception ex)
        //    {
        //        var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLemichsaSadsran.GetHashCode(), objOved.Taarich, "",ex);
        //        throw (exec);
        //    }
        //}
        ...
        //    catch (Exception ex)
        //    {
        //        var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLemichsaRakaz.GetHashCode(), objOved.Taarich, "",ex);
        //        throw (exec);
        //    }
        //}
        ...
        //    catch (Exception ex)
        //    {
        //        var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLemichsaMeshaleach.GetHashCode(), objOved.Taarich, "",ex);
        //        throw (exec);
        //    }
        //}
        ...
        private void CalcRechiv174()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMachlifPakach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv175()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMachlifSadran.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv176()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMachlifRakaz.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv177()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMachlifMeshaleach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv178()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMachlifKupai.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv179()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotPakach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv180()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotSadran.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv181()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotRakaz.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv182()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotMeshalech.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv183()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotKupai.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv184()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMichutzLamichsaNihulTnua.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv185()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.KizuzMishpatChaverim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv186()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaTafkidShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv187()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaNihulShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv188()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotNahagut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv189()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotNehigaShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv190()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotNihulTnua.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv191()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotNihulShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv192()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotTafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv193()
        {
            ...
            try
            {
                ...
                if (fSumDakotRechiv > 0)
                {
                    ...
                    fSumDakotRechiv +=  oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.HashlamaBetafkid);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotTafkidShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv194()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv195()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutBeshishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv196()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutShabat.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv198()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NosafotShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv200()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaChol.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv201()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv202_2()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaBeShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv203()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotPremiaVisaShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv207()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaTafkidShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv208()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MichutzLamichsaTnuaShishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv209()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutPremiaLerishum.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv210()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutPremiaMevakrim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv211_212()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutPremiaMeshekMusachim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }

        private void CalcRechiv211_212_2()
        {
            float fSumRechivMusachim, fSumRechivAchsana, fZmanAruchatBoker, fZmanAruchatTzharayim, fZmanAruchatErev;
            int iBokerRechiv, iTzharyimRechiv, iErevRechiv;
            try
            {
                //if (objOved.sSugYechida.ToLower() == "m_ms" || objOved.sSugYechida.ToLower() == "m_me")
                //{
                 oSidur.CalcRechiv211_212_2(out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev, out  iBokerRechiv, out  iTzharyimRechiv, out  iErevRechiv);
                ...
                fSumRechivMusachim = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_SIDUR"], clGeneral.enRechivim.NochehutPremiaMeshekMusachim2.GetHashCode(), objOved.Taarich);
                fSumRechivAchsana = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_SIDUR"], clGeneral.enRechivim.NochehutPremiaMeshekAchsana2.GetHashCode(), objOved.Taarich);
                if (iBokerRechiv == clGeneral.enRechivim.NochehutPremiaMeshekMusachim2.GetHashCode())
                {
                    fSumRechivMusachim = fSumRechivMusachim - fZmanAruchatBoker;
                }
                else
                ...
                if (iTzharyimRechiv == clGeneral.enRechivim.NochehutPremiaMeshekMusachim2.GetHashCode())
                {
                    fSumRechivMusachim = fSumRechivMusachim - fZmanAruchatTzharayim;
                }
                else
                ...
                if (iErevRechiv == clGeneral.enRechivim.NochehutPremiaMeshekMusachim2.GetHashCode())
                {
                    fSumRechivMusachim = fSumRechivMusachim - fZmanAruchatErev;
                }
                else
                ...
                addRowToTable(clGeneral.enRechivim.NochehutPremiaMeshekAchsana2.GetHashCode(), fSumRechivAchsana);
                addRowToTable(clGeneral.enRechivim.NochehutPremiaMeshekMusachim2.GetHashCode(), fSumRechivMusachim);
        ...
        private void CalcRechiv276()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochechutLePremiyaMeshekGrira.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv277()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochechutLePremiyaMeshekKonenutGrira.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv213()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachNesiot.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv214()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotHistaglut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv215()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachKM.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv216()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachKMVisaLepremia.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv217()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotHagdara.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv218()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotKisuiTor.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv219()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ShaotChofesh.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv220()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotHeadrut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv221()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotChofesh.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv223()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLepremiaMachsanKartisim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv233()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatMifalYetzur.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(101).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatMifalYetzur.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv234()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatNehageyTovala.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(102).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatNehageyTovala.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv235()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatNehageyTenderim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv236()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatDfus.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(104).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatDfus.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv237()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatAchzaka.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(105).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatAchzaka.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv238()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatGifur.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(106).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatGifur.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv239()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyaRishonLetzyon.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(107).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyaRishonLetzyon.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv240()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyaTechnayYetzur.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(108).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyaTechnayYetzur.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv241()
        {
            ...
            try
            {
                ...
                oSidur.CalcNochehutPremia(clGeneral.enRechivim.NochehutLePremyatPerukVeshiputz.GetHashCode(), (objOved.objMeafyeneyOved.GetMeafyen(110).IntValue > 0 ? true : false), out fZmanAruchatBoker, out fZmanAruchatTzharayim, out fZmanAruchatErev);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLePremyatPerukVeshiputz.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv245()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.EshelLeEggedTaavura.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv246()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochechutLepremyaMenahel.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv248()
        {
            ...
            try
            {
                ...
                fDakotNochehut = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich);
                fMichsaYomit = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.MichsaYomitMechushevet.GetHashCode(), objOved.Taarich);
                if (fDakotNochehut == 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0 && objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is null", "shat_hatchala_sidur ASC").Length > 0)
                {
                    fSumDakotRechiv = 1;
                }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomChofeshNoDivuach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv249()
        {
            ...
            try
            {
                ...
                fDakotNochehut = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode(), objOved.Taarich);
                fMichsaYomit = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.MichsaYomitMechushevet.GetHashCode(), objOved.Taarich);
                if (fDakotNochehut == 0 && fMichsaYomit > 0 && objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1 && objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is null", "shat_hatchala_sidur ASC").Length > 0)
                {
                    fSumDakotRechiv = 1;
                }
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomHeadrutNoDivuach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv250()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachNosafotTafkidCholVeshishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv251()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachNosafotTnuaCholVeshishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv252()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachNosafotNahagutCholVeshishi.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv256()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLepremiaManasim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv260()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochehutLepremiaPakach.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        private void CalcRechiv261()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MachalaYomMale.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv262()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.MachalaYomChelki.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv263()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HashlamaBenahagut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv264()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HashlamaBenihulTnua.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv265()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HashlamaBetafkid.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv266()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.YomMiluimChelki.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv267()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotElementim.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv268()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotNesiaLepremia.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv269()
        {
            ...
            try
            {
                ...
                fErechRechiv = fErechRechiv + oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.YomMachalaMisradHaBitachon); 
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotChofeshHeadrut.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv271()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.ZmanLilaSidureyBoker.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        {
            float ferech=0, fRechiv2, fRechiv76, fRechiv189;
            try
            {
                if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() &&  objOved.objPirteyOved.iKodMaamdMishni != clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())
                {
                    fRechiv2 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNehigaChol.GetHashCode(), objOved.Taarich);
                    fRechiv76 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.Nosafot125.GetHashCode(), objOved.Taarich);
                    fRechiv189 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.SachDakotNehigaShishi.GetHashCode(), objOved.Taarich);

                    if (fRechiv2 > 0 && !clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                    {
                        ferech = Math.Min(fRechiv76, fRechiv2);
                    }

                    if (fRechiv189 > 0)
                    {
                        ferech = Math.Min(fRechiv76, fRechiv189);
                    }
        ...
        {
            float ferech=0, fRechiv2, fRechiv76, fRechiv77, fRechiv299, fRechiv189;
            try
            {
                if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() && objOved.objPirteyOved.iKodMaamdMishni != clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())
                {
                    fRechiv2 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNehigaChol.GetHashCode(), objOved.Taarich);
                    fRechiv299 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.Shaot125LetashlumNahagut.GetHashCode(), objOved.Taarich);
                    fRechiv76 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.Nosafot125.GetHashCode(), objOved.Taarich);
                    fRechiv77 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.Nosafot150.GetHashCode(), objOved.Taarich);
                    fRechiv189 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.SachDakotNehigaShishi.GetHashCode(), objOved.Taarich);

                    if (fRechiv2 > 0 && !clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich) &&
                        fRechiv299 > 0 && fRechiv2 > fRechiv299)
                    {
                        ferech = Math.Min(fRechiv2 - fRechiv76, fRechiv77);
                    }

                    if (fRechiv189 > 0 && fRechiv299 > 0 && fRechiv189 > fRechiv299)
                    {
                        ferech = Math.Min(fRechiv189 - fRechiv76, fRechiv77);
                    }
        ...
        {
            float ferech, fRechiv35, fRechiv78;
            try
            {
                if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() && objOved.objPirteyOved.iKodMaamdMishni != clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())
                {
                    fRechiv35 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNehigaShabat.GetHashCode(), objOved.Taarich);

                    if (fRechiv35 > 0)
                    {
                        fRechiv78 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.NosafotShabat.GetHashCode(), objOved.Taarich);
                        ferech = Math.Min(fRechiv35, fRechiv78);
        ...
        {
            float ferech, fRechiv2, fRechiv131;
            try
            {
                if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() && objOved.objPirteyOved.iKodMaamdMishni != clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())
                {
                    ...
                    if (fRechiv2 > 0 && clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                    {
                        fRechiv131 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.ShaotShabat100.GetHashCode(), objOved.Taarich);
                        ferech = Math.Min(fRechiv2, fRechiv131);
        ...
        {
            float ferech, fRechiv2, fRechiv126, fRechiv299, fRechiv300;
            try
            {
                if (objOved.objPirteyOved.iKodMaamdRashi == clGeneral.enMaamad.Salarieds.GetHashCode() && objOved.objPirteyOved.iKodMaamdMishni != clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())
                {
                    fRechiv2 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.DakotNehigaChol.GetHashCode(), objOved.Taarich);
                    fRechiv126 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.MichsaYomitMechushevet.GetHashCode(), objOved.Taarich);
                    if (fRechiv2 > 0 && fRechiv126 > 0)
                    {
                        fRechiv299 = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_YOM"], clGeneral.enRechivim.Shaot125LetashlumNahagut.GetHashCode(), objOved.Taarich);
        ...
        private void CalcRechiv931()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HalbashaTchilatYom.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private void CalcRechiv932()
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.HalbashaSofYom.GetHashCode(), objOved.Taarich, "",ex);
                throw (exec);
            }
        }
        ...
        private int CheckSugMishmeret()
        {
            ...
            try
            {
                ...
                if (dr.Length > 0)
                {
                    ...
                    iSugYomLemichsa = oCalcBL.GetSugYomLemichsa(objOved, objOved.Taarich, objOved.objPirteyOved.iKodSectorIsuk, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue);
                    iSugMishmeret = DateHelper.GetSugMishmeret(objOved.Mispar_ishi, objOved.Taarich, iSugYomLemichsa, dShatHatchala, dShatGmar, objOved.objParameters);
                }
                return iSugMishmeret;
            }
            catch (Exception ex)
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> CheckSugMishmeret", ex);    
                throw (exec);
            }
            finally
            {
        ...
        private bool HaveRechivimInDay(DateTime taarich, string lst_rechivim)
        {
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> HaveRechivimInDay", ex);
                throw (exec);
            }
        }
        private bool HaveRechivimInDay(DateTime taarich)
        {
            float fYomMachala, fYomMachalaBoded, fYomMachalatYeled, fYomMachaltHorim, fYomMachalaBenZug, fYomShmiratHerayon, fYomMiluim,fmisradHabitachon;
            ...
            try
            {
                ...
                fYomShmiratHerayon = oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.YomShmiratHerayon);
                fYomMiluim = oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.YomMiluim);
                fmisradHabitachon = oCalcBL.GetSumErechRechiv(ListOfSum, clGeneral.enRechivim.YomMachalaMisradHaBitachon);

                if (fYomMachala == 0 && fYomMachalaBoded == 0 && fYomMachalatYeled == 0 && fYomMachaltHorim == 0
                    && fYomMachalaBenZug == 0 && fYomShmiratHerayon == 0 && fYomMiluim == 0 && fmisradHabitachon ==0)
                {
                    return false;
                } return true;
            }
        ...
        public void ChishuvEmptyYemeyAvoda(clGeneral.enRechivim iKodRechiv, bool bBefore)
        {
            ...
            int sug_yom;
            MeafyenimDM objMeafyeneyOved= null;
            try
            {
                ...
                if (iKodRechiv == clGeneral.enRechivim.DakotHeadrut)
                {
                    ...
                    {
                        sug_yom = DateHelper.GetSugYom(objOved.oGeneralData.dtYamimMeyuchadim, taarich_me, objOved.oGeneralData.dtSugeyYamimMeyuchadim);
                        if (sug_yom != enSugYom.Shishi.GetHashCode() &&
                ...
                if (iKodRechiv == clGeneral.enRechivim.DakotHeadrut)
                {
                    objMeafyeneyOved = objOved.MeafyeneyOved.Find(Meafyenim => (Meafyenim.Taarich ==(bBefore ? objOved.dTchilatAvoda : objOved.Month) ));
                }      
                ...
                while (taarich_me < taarich_ad)
                {
                    ...
                    if ((sug_yom != enSugYom.Shishi.GetHashCode() &&
                        !clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, sug_yom, taarich_me) )
                        || iKodRechiv == clGeneral.enRechivim.MichsaYomitMechushevet)
                    {
                        switch (iKodRechiv)
                        {
                            ...
                            case clGeneral.enRechivim.DakotHeadrut:
                                ...
                                if (objMeafyeneyOved.GetMeafyen(56).IntValue == enMeafyenOved56.enOved6DaysInWeek1.GetHashCode())
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> ChishuvEmptyYemeyAvoda", ex);    
                throw (exec);
            }
        }
        ...
        public void CalcChofeshHeadrutToShguyim(clGeneral.enRechivim iKodRechiv)
        {
            ...
            try
            {
                ...
                while (dTarMe <= dTarAd)
                {
                    ...
                    if (fMichsaYomit > 0 && fDakotNochehut == 0 && fChofesh == 0 && fHeadrut == 0 && objOved.DtYemeyAvoda.Select("taarich=Convert('" + dTarMe.ToShortDateString() + "', 'System.DateTime') and Lo_letashlum=0 and mispar_sidur is not null").Length == 0)
                    {
                        ...
                        objOved.objMeafyeneyOved = objOved.MeafyeneyOved.Find(Meafyenim => (Meafyenim.Taarich == dTarMe));
                        objOved.SetMatzavOved();

                        lstPail = "01,03,04,05,06,07";
                        if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 0)
                        {
                            if(lstPail.IndexOf(objOved.sMatazavOved) == -1)
                                addRowToTable(clGeneral.enRechivim.YomHeadrut.GetHashCode(), dTarMe, 1);
                            else
                        ...
                        if (objOved.objMeafyeneyOved.GetMeafyen(33).IntValue == 1)
                        {
                            if (lstPail.IndexOf(objOved.sMatazavOved) > -1)
                            {
                                ...
                                {
                                    if (objOved.objMeafyeneyOved.GetMeafyen(33).ErechIshi != "1")
                                        addRowToTable(clGeneral.enRechivim.YomChofesh.GetHashCode(), dTarMe, 1);
                                    ...
                                    if (objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.Aray.GetHashCode() || objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.GimlaiBechoze.GetHashCode() ||
                                         ...
                                         objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.GimlayTaktziviBechoze.GetHashCode() || objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.PensyonerTakziviBechoze.GetHashCode())
                                        addRowToTable(clGeneral.enRechivim.YomHeadrut.GetHashCode(), dTarMe, 1);
            ...
            {
                var exec = SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcDay--> CalcChofeshHeadrutToShguyim", ex);     
                throw (exec);
            }
        }
