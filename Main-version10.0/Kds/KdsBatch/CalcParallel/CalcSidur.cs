      ...
      //  public int SugYom { get; set; }
        ...
        public float CalcRechiv1BySidur(DataRow drSidur, float fMichsaYomit, CalcPeilut oPeilut)
        {
              ...
              //  iSugYom = SugYom;
                ...
                else if (!string.IsNullOrEmpty(drSidur["shat_gmar_auto"].ToString()))
                {
                   //ג.	סידור עם מאפיין שעת גמר אוטומטית לחישוב:
                    ...
                    fErechRechiv =float.Parse((DateHelper.GetDateTimeFromStringHour(drSidur["shat_gmar_auto"].ToString(), objOved.Taarich)  - dShatHatchalaLetashlum).TotalMinutes.ToString());
                }
                //	סידורים מוגבלים בדקות התשלום היומיות  
                else if (!string.IsNullOrEmpty(drSidur["max_shaot_byom_hol"].ToString()) && objOved.SugYom == enSugYom.Chol.GetHashCode())
                {
                    fErechRechiv = Math.Min(fErechRechiv, int.Parse(drSidur["max_shaot_byom_hol"].ToString()));
                }
                else if (!string.IsNullOrEmpty(drSidur["max_shaot_byom_shishi"].ToString()) && objOved.SugYom == enSugYom.Shishi.GetHashCode())
                {
                    fErechRechiv = Math.Min(fErechRechiv, int.Parse(drSidur["max_shaot_byom_shishi"].ToString()));
                }
                else if (!string.IsNullOrEmpty(drSidur["max_shaot_beshabaton"].ToString()) && objOved.SugYom == enSugYom.Shabat.GetHashCode() && (!(iMisparSidur == 99006 && objOved.objPirteyOved.iKodMaamdMishni == clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode())))
                {
                    fErechRechiv = Math.Min(fErechRechiv, int.Parse(drSidur["max_shaot_beshabaton"].ToString()));
                }
                //•	סידורים המזכים בדקות קבועות ליום עבודה
                else if (fErechRechiv>0 && !string.IsNullOrEmpty(drSidur["tashlum_kavua_bchol"].ToString()) && objOved.SugYom == enSugYom.Chol.GetHashCode())
                {
                    fErechRechiv = float.Parse(drSidur["tashlum_kavua_bchol"].ToString());
                }
                else if (fErechRechiv > 0 && !string.IsNullOrEmpty(drSidur["tashlum_kavua_beshishi"].ToString()) && objOved.SugYom == enSugYom.Shishi.GetHashCode())
                {
                    fErechRechiv = float.Parse(drSidur["tashlum_kavua_beshishi"].ToString());
                }
                else if (fErechRechiv > 0 && !string.IsNullOrEmpty(drSidur["shabaton_tashlum_kavua"].ToString()) && objOved.SugYom == enSugYom.Shabat.GetHashCode())
                {
            ...
            //}
                ...
                {//•	סידור 99006 (8554) – שליחות בחו"ל: 
                    if ((objOved.SugYom == enSugYom.Chol.GetHashCode() || (objOved.SugYom >= enSugYom.CholHamoedSukot.GetHashCode() && objOved.SugYom <= enSugYom.Purim.GetHashCode())) || (oCalcBL.CheckErevChag(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom) && !oCalcBL.CheckYomShishi(objOved.SugYom)))
                    {
                ...
                { //•	סידור עם מאפיין ריאלי ועד מכסה:
                    ...
                    if (iMisparSidur == 99011 && objOved.objPirteyOved.iGil == enKodGil.enTzair.GetHashCode() && fErechRechiv >= 480)
                ...
                //    if (objOved.SugYom == enSugYom.Chol.GetHashCode() || oCalcBL.CheckErevChag(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom))
                //    {
                ...
                else if (!string.IsNullOrEmpty(drSidur["michsat_shishi_lebaley_x"].ToString()) && fMichsaYomit > 0 && objOved.SugYom == enSugYom.Shishi.GetHashCode())
                {
                ...
                if (!string.IsNullOrEmpty(drSidur["sidur_namlak_visa"].ToString()))
                {
                    if (int.Parse(drSidur["sidur_namlak_visa"].ToString()) == 2 && (drSidur["sidur_rak_lechevrot_banot"].ToString() == "" || objOved.Taarich>=DateTime.Parse("01/05/2013")))
                    {
                        ...
                        {
                            //ב
                            dTempDtFrom = DateHelper.GetDateTimeFromStringHour("00:01", objOved.Taarich.Date);
                            dTempDtTo = DateHelper.GetDateTimeFromStringHour("13:59", objOved.Taarich.Date);
                            ...
                            //ג
                            dTempDtFrom = DateHelper.GetDateTimeFromStringHour("14:00", objOved.Taarich.Date);
                            dTempDtTo = DateHelper.GetDateTimeFromStringHour("24:00", objOved.Taarich.Date);
                            ...
                            //ד
                            if (fMichsaYomit == 0 && objOved.SugYom == enSugYom.Shishi.GetHashCode())
                            {
                        ...
                        else if (int.Parse(drSidur["yom_VISA"].ToString()) == 2 && !clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich) && (objOved.SugYom == enSugYom.Chol.GetHashCode() || objOved.SugYom == enSugYom.Shishi.GetHashCode()))
                        {
                            //ו
                        ...
                        else if (int.Parse(drSidur["yom_VISA"].ToString()) == 3 && !clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich) && (objOved.SugYom == enSugYom.Chol.GetHashCode() || objOved.SugYom == enSugYom.Shishi.GetHashCode()))
                        {
                           //ח
            ...
            try
            {
                ...
                if (_drSidurRagil.Length > 0)
                {
                    for (int I = 0; I < _drSidurRagil.Length; I++)
                    {
                        ...
                        bYeshSidur = CheckSugSidur(clGeneral.enMeafyen.SectorAvoda.GetHashCode(), enSectorAvoda.Nahagut.GetHashCode(), objOved.Taarich, iSugSidur);
                        if (bYeshSidur)
                        {
                          ...
                          //  dShatGmarLetashlum = dShatGmarLetashlum.AddMinutes(+fTosefetGrirotHatchala);
                            ...
                            if (objOved.SugYom == enSugYom.Chol.GetHashCode() && (_drSidurRagil[I]["sidur_namlak_visa"].ToString().Trim() == "1" || _drSidurRagil[I]["sidur_namlak_visa"].ToString().Trim() == "2"))
                            {
                ...
                for (int I = 0; I <= _drSidurMeyuchad.Length - 1; I++)
                {
                 ...
                 //   iSugYom = SugYom;
                   ...
                   // dShatGmarLetashlum = dShatGmarLetashlum.AddMinutes(+fTosefetGrirotHatchala);
                    ...
                    if (objOved.SugYom == enSugYom.Chol.GetHashCode() && (_drSidurMeyuchad[I]["sidur_namlak_visa"].ToString().Trim() =="1" || _drSidurMeyuchad[I]["sidur_namlak_visa"].ToString().Trim() == "2"))
                    {
                        fErech = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_SIDUR"].Compute("SUM(ERECH_RECHIV)", "MISPAR_SIDUR=" + iMisparSidur + " AND SHAT_HATCHALA=Convert('" + dShatHatchalaSidur.ToString() + "', 'System.DateTime') AND KOD_RECHIV=" + clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode().ToString() + " and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')"));
                        addRowToTable(clGeneral.enRechivim.DakotNehigaChol.GetHashCode(), dShatHatchalaSidur, iMisparSidur, fErech, iMichutzLamichsa);
                    }
        ...
        public void CalcRechiv7()
        {
          int iMisparSidur, iSugSidur;
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotZikuyChofesh.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            //finally
            //{
        ...
        public void CalcRechiv10()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotTamritzTafkid.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv12()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotTamritzTafkid.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv12", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv13()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifMeshaleach.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv13", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv14()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifSadran.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv14", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv15()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifPakach.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv15", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv16()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifKupai.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv16", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv17()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.DakotMachlifRakaz.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv17", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv18()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotNochehutBefoal.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv22()
        {
                        ...
                        if (objOved.objMeafyeneyOved.GetMeafyen(60).IntValue != 0 )
                        {
                            if (iMisparSidur.ToString().Substring(0, 2) == "99")
                            {
                                //אם הסידור הוא סידור מיוחד עם ערך 7 במאפיין 52 (קופאי):
                                    //  ערך הרכיב = דקות נוכחות לתשלום (רכיב 1)
                                 if (drSidurim[I]["SUG_AVODA"].ToString() == enSugAvoda.Kupai.GetHashCode().ToString())
                                {
                                    fSumDakotRechiv = oCalcBL.GetSumErechRechiv(_dtChishuvSidur.Compute("SUM(ERECH_RECHIV)", "KOD_RECHIV=" + clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode().ToString() + " and mispar_sidur=" + iMisparSidur + " AND SHAT_HATCHALA=Convert('" + dShatHatchalaSidur.ToString() + "', 'System.DateTime') and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')"));
                                }
                            ...
                            //  ערך הרכיב = דקות נוכחות לתשלום (רכיב 1)
                            else if (oCalcBL.CheckSugSidur(objOved, clGeneral.enMeafyen.SugAvoda.GetHashCode(), enSugAvoda.Kupai.GetHashCode(), iSugSidur))
                            {
                                fSumDakotRechiv = oCalcBL.GetSumErechRechiv(_dtChishuvSidur.Compute("SUM(ERECH_RECHIV)", "KOD_RECHIV=" + clGeneral.enRechivim.DakotNochehutLetashlum.GetHashCode().ToString() + " and mispar_sidur=" + iMisparSidur + " AND SHAT_HATCHALA=Convert('" + dShatHatchalaSidur.ToString() + "', 'System.DateTime') and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')"));
                            }
                        }
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, iKodRechiv, objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv23()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotSikun.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv26_2()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv26()
        {
            ...
            int iMisparSidur, iSugSidur;
            bool bYeshSidur, bChishuv, bHoraatNehigaLechishuv ;
            DateTime dShatHatchalaSidur;
            DataRow[] _drSidurMeyuchad, _drSidurRagil;
            float fErechRechiv, fDakotNochehutSidur, fTosefetGil, fMichsaYomit, fNuchehutLepremia, fZmanElementZar;
            ...
            try
            {
                ...
                if (_drSidurRagil.Length > 0)
                {
                    for (int I = 0; I < _drSidurRagil.Length; I++)
                    {
                        ...
                        fTosefetGil = 0;
                        bChishuv = true;
                        bHoraatNehigaLechishuv = true;
                        if (_drSidurRagil[I]["sidur_namlak_visa"].ToString() == "")
                        {
                            iMisparSidur = int.Parse(_drSidurRagil[I]["mispar_sidur"].ToString());
                            iSugSidur = int.Parse(_drSidurRagil[I]["sug_sidur"].ToString());
                            bYeshSidur = CheckSugSidur(clGeneral.enMeafyen.SectorAvoda.GetHashCode(), enSectorAvoda.Nahagut.GetHashCode(), objOved.Taarich, iSugSidur);
                            if (iSugSidur == 73 && objOved.Month >= objOved.objParameters.dTaarichBitulPremiaNahagutForHoraa)
                                bHoraatNehigaLechishuv = false;
                            if (bYeshSidur &&  bHoraatNehigaLechishuv)
                            {
                                iMisparSidur = int.Parse(_drSidurRagil[I]["mispar_sidur"].ToString());
                                dShatHatchalaSidur = DateTime.Parse(_drSidurRagil[I]["shat_hatchala_sidur"].ToString());
                                // dShatHatchalaLetashlum = DateTime.Parse(_drSidurRagil[I]["shat_hatchala_letashlum"].ToString());
                               ...
                               // if (dShatHatchalaSidur < objOved.objParameters.dKnisatShabat)
                                ...
                                if (bChishuv)
                                {
                                    ...
                                    if ((fDakotHagdara + fDakotLepremia) > 0)
                                    {
                                        ...
                                        {
                                            fZmanElementZar = oCalcBL.GetSumErechRechiv(objOved._dsChishuv.Tables["CHISHUV_SIDUR"].Compute("SUM(ERECH_RECHIV)", "MISPAR_SIDUR=" + iMisparSidur + " AND SHAT_HATCHALA=Convert('" + dShatHatchalaSidur.ToString() + "', 'System.DateTime') AND KOD_RECHIV=" + clGeneral.enRechivim.ZmanElementZarNahagut.GetHashCode().ToString() + " and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')"));
                                            fErechRechiv = float.Parse((fDakotHagdara + fSumDakotSikun + fDakotHistaglut + fDakotKisuyTor + fDakotLepremia + fZmanElementZar + fTosefetGil - fNuchehutLepremia).ToString());
                                        }
                                    }
                ...
                for (int I = 0; I <= _drSidurMeyuchad.Length - 1; I++)
                {
                    ...
                    bHoraatNehigaLechishuv = true;
                    iMisparSidur = int.Parse(_drSidurMeyuchad[I]["mispar_sidur"].ToString());
                    if (_drSidurMeyuchad[I]["sug_avoda"].ToString() == enSugAvoda.Nahagut.GetHashCode().ToString() && objOved.Month >= objOved.objParameters.dTaarichBitulPremiaNahagutForHoraa)
                        bHoraatNehigaLechishuv = false;
                    if (iMisparSidur != 99220 && (string.IsNullOrEmpty(_drSidurMeyuchad[I]["sidur_namlak_visa"].ToString())) && bHoraatNehigaLechishuv)
                    {
                        dShatHatchalaSidur = DateTime.Parse(_drSidurMeyuchad[I]["shat_hatchala_sidur"].ToString());
                        //  dShatHatchalaLetashlum = DateTime.Parse(_drSidurMeyuchad[I]["shat_hatchala_letashlum"].ToString());
                        if (oCalcBL.CheckErevChag(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom) && dShatHatchalaSidur < objOved.objParameters.dKnisatShabat)
        ...
        public void CalcRechiv28()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaVisa.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv29()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaVisaShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv30_2(out string sMispareySidur)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaYomit.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv30()
        {
            ...
            int iMisparSidur, iSugSidur;
            bool bYeshSidur, bErevChag, bHoraatNehigaLechishuv;
            DateTime dShatHatchalaLetashlum,dShatGmarLetashlum, dShatHatchalaSidur; 
            DataRow[] _drSidurMeyuchad, _drSidurRagil;
            float fErechRechiv, fDakotNochehutSidur, fTosefetGil, fMichsaYomit, fNuchehutLepremia, fZmanElementZar;
            float fDakotHagdara,fSumDakotSikun, fDakotHistaglut, fSachNesiot, fDakotLepremia , fDakotKisuyTor;
        ...
        public void CalcRechiv35()
        {
                ...
                //{
                    ...
                    for (int I = 0; I < _drSidurMeyuchad.Length; I++)
                    {
                        ...
                        if (clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                        {
                            ...
                            else if (dShatGmarLetashlum > objOved.objParameters.dShatMaavarYom)
                            {
                                fErechRechiv = float.Parse((objOved.objParameters.dShatMaavarYom - dShatHatchalaSidur).TotalMinutes.ToString());
                                addRowToTable(clGeneral.enRechivim.DakotNehigaShabat.GetHashCode(), dShatHatchalaSidur, iMisparSidur, fErechRechiv);
                            }
                        }
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotNehigaShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv36()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotNihulTnuaShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv37()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotTafkidShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float GetSumMinutsBeforeShabat()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur: GetSumMinutsBeforeShabat", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv38()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachEshelBoker.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv40()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachEshelErev.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv42()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachEshelTzaharayim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv39_41_43()
        {
                ...
                for (int I = 0; I < drSidurim.Length; I++)
                {
                    if (!string.IsNullOrEmpty(drSidurim[I]["KOD_SIBA_LEDIVUCH_YADANI_IN"].ToString()))
                    {
                        if (( (int.Parse(drSidurim[I]["KOD_SIBA_LEDIVUCH_YADANI_IN"].ToString()) == 10 || int.Parse(drSidurim[I]["KOD_SIBA_LEDIVUCH_YADANI_OUT"].ToString()) == 10)||
                             (objOved.objMeafyeneyOved.GetMeafyen(50).Value == "1" && objOved.objPirteyOved.iIsuk == 178) ||
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachEshelErevMevkrim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        private void CalcRechiveyEshelMichshuv(int iMisparSidur, DateTime dShatHatchalaSidur, float fDakotNochehutSidur, DateTime dShatHatchalaLetashlum, DateTime dShatGmarLetashlum)
        {
            ...
            {
                //1 
                if (objOved.SugYom == enSugYom.Chol.GetHashCode() || objOved.SugYom == enSugYom.CholHamoedPesach.GetHashCode() ||
                   objOved.SugYom == enSugYom.CholHamoedSukot.GetHashCode() || objOved.SugYom == enSugYom.Purim.GetHashCode())
                {
                ...
                if (objOved.SugYom == enSugYom.Shabat.GetHashCode() || clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                {
                ...
                //3
                if (objOved.SugYom == enSugYom.Shishi.GetHashCode() || oCalcBL.CheckErevChag(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom))
                {
        ...
        public void CalcRechiv52()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachDakotLepremia.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv53()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enMeafyenim.HamaratShaot.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv54()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanLailaEgged.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv55()
        {
                        ...
                        if (drSidurim[I]["ein_leshalem_tos_lila"].ToString() == "")
                        {
                            ...
                            if (fZmanLilaSidureyBoker == 0)
                            {
                                ...
                                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                                {
                                    ...
                                    iIsuk = objOved.objPirteyOved.iIsuk;
                                    if ((iIsuk == 122 || iIsuk == 123 || iIsuk == 124 || iIsuk == 127) && iMisparSidur == 99001 && DateHelper.GetSugMishmeret(objOved.Mispar_ishi, objOved.Taarich, objOved.SugYom, dShatHatchalaLetashlum, dShatGmarLetashlum, objOved.objParameters) == enSugMishmeret.Liyla.GetHashCode())
                                    {
                                ...
                                else if (objOved.SugYom < enSugYom.Shishi.GetHashCode())
                                {
                                    dShatHatchalaLetashlum = DateTime.Parse(drSidurim[I]["shat_hatchala_letashlum"].ToString());
                                    if (isHafsakaLast)
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanLailaChok.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv62(out int iCount)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.YomMiluim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv63(out int iCount)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.YomAvodaBechul.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv67()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.YomChofesh.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv80()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotMichutzTafkidChol.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv81()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotMichutzLamichsaShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv85()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachTosefetRetzifut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv86()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.KizuzDakotHatchalaGmar.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv88()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanAruchatTzaraim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv89()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.KizuzBevisa.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv92(float fMichsaYomit, float fNochehutLetashlum)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.Shaot50.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        //    catch (Exception ex)
        //    {
        //        var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanHashlama.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
        //        throw (excep);
        //    }
        //}
        ...
        public float CalcRechiv96(ref float fSumDakotLaylaEgged, ref float fSumDakotLaylaChok, ref float fSumDakotLaylaBoker , ref float fSumDakotShabat)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanRetzifutNehiga.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        private bool isSidurNihulTnuaOrTafkidMezakeRezifut(ref DataRow drSidurim)
        {
            ...
            try
            {
                ...
                //    bYeshSidur = CheckSugSidur(clGeneral.enMeafyen.SectorAvoda.GetHashCode(), enSectorAvoda.Nihul.GetHashCode(), objOved.Taarich, iSugSidur);
                //    if (bYeshSidur)
                //        bSidurNihulOrTafkid = true;
                //    else
                //    {
        ...
        private bool isSidurNihulTnua(DataRow drSidurim)
        {
            ...
            try
            {
                ...
                if (iMisparSidur.ToString().Substring(0, 2) == "99" && drSidurim["sector_avoda"].ToString() == enSectorAvoda.Nihul.GetHashCode().ToString())
        ...
        private bool isSidurTafkid(DataRow drSidurim)
        {
            ...
            try
            {
                ...
                if (iMisparSidur.ToString().Substring(0, 2) == "99" && drSidurim["sector_avoda"].ToString() == enSectorAvoda.Tafkid.GetHashCode().ToString())
                    bSidurTafkid = true;
                else
                {
                    iSugSidur = int.Parse(drSidurim["sug_sidur"].ToString());
                    ...
                    if (iMisparSidur.ToString().Substring(0, 2) != "99")
                    {
                        bYeshSidur = CheckSugSidur(clGeneral.enMeafyen.SectorAvoda.GetHashCode(), enSectorAvoda.Tafkid.GetHashCode(), objOved.Taarich, iSugSidur);
                        if (bYeshSidur)
                            bSidurTafkid = true;
                    }
                    else
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, 0, objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "" + ex.Message, null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv97(ref float fSumDakotLaylaEgged, ref float fSumDakotLaylaChok)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanRetzifutTafkid.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv125()
        {
                        ...
                        if (drSidureyGrira.Length > 0)
                        {
                            for (int J = 0; J < drSidureyGrira.Length; J++)
                            {
                                ...
                                if (drSidureyGrira[J]["mispar_sidur"].ToString().Substring(0, 2) != "99")
                                {
                                    ...
                                    if (CheckSugSidur(clGeneral.enMeafyen.SugAvoda.GetHashCode(), enSugAvoda.Grira.GetHashCode(), objOved.Taarich, iSugSidur))
                                    {
                                        bNotCalc = true;
                                        break;
                                ...
                                else if (drSidureyGrira[J]["sug_avoda"].ToString() == enSugAvoda.Grira.GetHashCode().ToString())
                                {
                                    bNotCalc = true;
                                    break;
                                }
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.MishmeretShniaBameshek.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv128()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanGrirot.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv131(ref float fZmanAdShabat, ref float fZmanafterShabat)
        {
            ...
            try
            {
                ...
                if (!(objOved.objPirteyOved.iDirug == 85 && objOved.objPirteyOved.iDarga == 30))
                {
                    ...
                    {
                        _drSidurim = null;
                        _drSidurim = objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is not null and MISPAR_SIDUR=99006");
                        for (int I = 0; I < _drSidurim.Length; I++)
                        {
                            iMisparSidur = int.Parse(_drSidurim[I]["mispar_sidur"].ToString());
                            fErech = 0;
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ShaotShabat100.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv132()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ChofeshZchut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv133()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.PremyaRegila.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv134()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.PremyaNamlak.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv142()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.KizuzNochehut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv179()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotPakach.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv179", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv180()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotSadran.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv180", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv181()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotRakaz.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv181", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv182()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotMeshalech.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv182", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv183()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.SachDakotKupai.GetHashCode(), objOved.Taarich, "CalcSidur-->CalcRechiv183", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv184()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotMichutzLamichsaNihulTnua.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv186()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.MichutzLamichsaTafkidShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv187()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.MichutzLamichsaNihulShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv189()
        {
                    ...
                    for (int I = 0; I < _drSidurRagil.Length; I++)
                    {
                        ...
                        if (bYeshSidur)
                        {
                           ...
                           // dShatHatchalaLetashlum = dShatHatchalaLetashlum.AddMinutes(-fTosefetGrirotSof);
                            ...
                            iSugYomNext = DateHelper.GetSugYom(objOved.oGeneralData.dtYamimMeyuchadim, DateTime.Parse(objOved.Taarich.ToShortDateString()).AddDays(1),objOved.oGeneralData.dtSugeyYamimMeyuchadim);//, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue);
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachDakotNehigaShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv191()
        {
            ...
            //ערך מאפיין זה (סוג עבודה) = 4 =  ניהול תנועה.
            int iMisparSidur, iSugSidur;
            bool bYeshSidur, bSidurNihulTnua=false;
            ...
            try
            {
               ...
               // _drSidurMeyuchad = GetSidurimMeyuchadim("sector_avoda", clGeneral.enSectorAvoda.Nihul.GetHashCode());
                _drSidurMeyuchad = objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0  and mispar_sidur is not null and SUBSTRING(convert(mispar_sidur,'System.String'),1,2)=99");

                for (int I = 0; I < _drSidurMeyuchad.Length; I++)
                {
                    bSidurNihulTnua = isSidurNihulTnua(_drSidurMeyuchad[I]);
                    if (bSidurNihulTnua)
                    {
                        iMisparSidur = int.Parse(_drSidurMeyuchad[I]["mispar_sidur"].ToString());
                        dShatHatchalaSidur = DateTime.Parse(_drSidurMeyuchad[I]["shat_hatchala_sidur"].ToString());
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachDakotNihulShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv192()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachDakotTafkid.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv193()
        {
            ...
            //ערך מאפיין זה (סוג עבודה) = 1 =  תפקיד.
            int iMisparSidur, iSugSidur;
            bool bYeshSidur, bSidurTafkid=false;
            int iSugYom, iSugYomNext;
            ...
            try
            {
               ...
               // _drSidurMeyuchad = GetSidurimMeyuchadim("sector_avoda", clGeneral.enSectorAvoda.Tafkid.GetHashCode());
                ...
                for (int I = 0; I < _drSidurMeyuchad.Length; I++)
                {
                    bSidurTafkid = isSidurTafkid(_drSidurMeyuchad[I]);
                      if (bSidurTafkid)
                      {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachDakotTafkidShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv194()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutChol.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv195()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutBeshishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv196()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutShabat.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv202()
        {
            ...
            int iMisparSidur, iSugSidur;
            bool bYeshSidur, bHoraatNehigaLechishuv ;
            DateTime dShatHatchalaSidur;
            DataRow[] _drSidurMeyuchad, _drSidurRagil;
            float fErechRechiv, fDakotNochehutSidur, fTosefetGil, fMichsaYomit, fNuchehutLepremia, fZmanElementZar;
            float fDakotHagdara, fSumDakotSikun, fDakotHistaglut, fSachNesiot, fDakotLepremia, fDakotKisuyTor;
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaBeShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv203()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotPremiaVisaShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
             finally
            {
        ...
        public void CalcRechiv207()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.MichutzLamichsaTafkidShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv208()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.MichutzLamichsaTnuaShishi.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv209()
        {
            ...
            try
            {
                ...
                for (int I = 0; I < _drSidurim.Length; I++)
                {
                    ...
                    dTempM1 = DateHelper.GetDateTimeFromStringHour("12:30", objOved.Taarich.Date);
                    dTempM2 = DateHelper.GetDateTimeFromStringHour("13:30", objOved.Taarich.Date);
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutPremiaLerishum.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv210(out float fZmanAruchatBoker, out float fZmanAruchatTzharim, out float fZmanAruchatErev)
        {
                ...
                if (!clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                {
                    if (objOved.objMeafyeneyOved.GetMeafyen(100).IntValue > 0)
                    {
                        ...
                        for (int I = 0; I < _drSidurim.Length; I++)
                        {
                            ...
                            dTempM1 = DateHelper.GetDateTimeFromStringHour("08:30", objOved.Taarich.Date);
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutPremiaMevakrim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv276()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochechutLePremiyaMeshekGrira.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv277()
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", clGeneral.enRechivim.NochechutLePremiyaMeshekKonenutGrira.GetHashCode(), objOved.Taarich, "", ex);
                throw (excep);
            }
        }
        public void CalcRechiv213()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachNesiot.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv214()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotHistaglut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv215()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachKM.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv216()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.SachKMVisaLepremia.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv217()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotHagdara.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv218()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotKisuiTor.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv223()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaMachsanKartisim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv235()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLePremyatNehageyTenderim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv246()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochechutLepremyaMenahel.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv256( out float fZmanAruchatTzharim,  out int iErevRechiv)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaManasim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        private void CalcZmaneyAruchot(DateTime dShatHatchalaLetaslum, DateTime dShatGmarLetashlum, out float fZmanAruchatTzharim, int iMaxDakot)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->CalcZmaneyAruchot", ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv257( out float fZmanAruchatTzharim, out int iErevRechiv)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaMetachnenTnua.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv73()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.YomShlichutBeChul.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv258( out float fZmanAruchatTzharim, out int iErevRechiv)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaSadran.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv259( out float fZmanAruchatTzharim, out int iErevRechiv)
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaRakaz.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv260( out float fZmanAruchatTzharim, out int iErevRechiv)
        {
            ...
            try
            {
                ...
                for (int I = 0; I < _drSidurim.Length; I++)
                {
                    ...
                    dShatHatchalaLetaslum = DateTime.Parse(_drSidurim[I]["shat_hatchala_letashlum"].ToString());
                    fErech = 0;
                    if (sSidurimLerchiv.Length > 0)
                        drSidurim = objOved.DtYemeyAvodaYomi.Select("Lo_letashlum=0 and mispar_sidur is not null and mispar_sidur=" + iMisparSidur + " and MISPAR_SIDUR IN(" + sSidurimLerchiv + ")");

                    if (!clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom, objOved.Taarich))
                    {
                        if ((iMisparSidur == 99205 ||  iMisparSidur==99216) && (objOved.objPirteyOved.iIsuk == 401 || objOved.objPirteyOved.iIsuk == 422))
                        {
                            iMaxDakot = 30;
                        ...
                        else if (drSidurim != null && drSidurim.Length > 0)
                        {
                            fErech = float.Parse((dShatGmarLetashlum - dShatHatchalaLetaslum).TotalMinutes.ToString());
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NochehutLepremiaPakach.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv263()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.HashlamaBenahagut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv264()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.HashlamaBenihulTnua.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv265()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.HashlamaBetafkid.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public float CalcRechiv266()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.YomMiluimChelki.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv267()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotElementim.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv268()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.DakotNesiaLepremia.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
                ...
                if (drSidurim.Length > 0)
                {
                    for (int I = 0; I < drSidurim.Length; I++)
                    {
                        if (drSidurim[I]["ein_leshalem_tos_lila"].ToString() == "")
                        {
                            ...
                            if ((iIsuk == 122 || iIsuk == 123 || iIsuk == 124 || iIsuk == 127) && iMisparSidur == 99001 && DateHelper.GetSugMishmeret(objOved.Mispar_ishi, objOved.Taarich, iSugYomLemichsa, dShatHatchalaSidur, DateTime.Parse(drSidurim[I]["shat_gmar_sidur"].ToString()), objOved.objParameters) == enSugMishmeret.Liyla.GetHashCode())
                            {
                            ...
                            dZmanTchilatTosLila = DateHelper.GetDateTimeFromStringHour("00:01", objOved.Taarich);
        ...
        public void CalcRechiv931()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.HalbashaTchilatYom.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv932()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.HalbashaSofYom.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null,ex);
                throw (excep);
            }
            finally
            {
        ...
        public void CalcRechiv295()
        {
            ...
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.NesiaBerechevMuganET.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null, ex);
                throw (excep);
            }
        }
        ...
        public void CalcRechiv296()
        {
            ...
            try
            {
                ...
                for (int I = 0; I < drSidurim.Length; I++)
                {
                    ...
                    fErech = oPeilut.CalcRechiv296(iMisparSidur, dShatHatchalaSidur);

                    addRowToTable(clGeneral.enRechivim.ZmanElementZarNahagut.GetHashCode(), dShatHatchalaSidur, iMisparSidur, fErech);
                }
            }
            catch (Exception ex)
            {
                var excep = SetError(objOved.iBakashaId, "E", null, clGeneral.enRechivim.ZmanElementZarNahagut.GetHashCode(), objOved.Mispar_ishi, objOved.Taarich, iMisparSidur, dShatHatchalaSidur, null, null, "", null, ex);
                throw (excep);
            }
        }
        ...
        private void CheckSidurCholToAdd(int iRechiv, int iMisparSidur, int iDay, int iSugYom, DateTime dShatHatchalaLetashlum, DateTime dShatGmarLetashlum, DateTime dShatHatchalaSidur, int iMichutzLamichsa, bool bCheckMafil)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->CheckSidurCholToAdd", ex);
                throw (excep);
            }
        }
        private void ChishuvShatYeziatShabat(int iMisparSidur, bool bCheckMafil, ref DateTime dShatGmarShabat)
        {
            ...
            if ((dNextDay.DayOfWeek.GetHashCode() + 1) == enDay.Shabat.GetHashCode())
            { bNextShabat = true; }
            else { bNextShabat = clDefinitions.CheckShaaton(objOved.oGeneralData.dtSugeyYamimMeyuchadim, DateHelper.GetSugYom(objOved.oGeneralData.dtYamimMeyuchadim, dNextDay, objOved.oGeneralData.dtSugeyYamimMeyuchadim), dNextDay); } //, objOved.objMeafyeneyOved.GetMeafyen(56).IntValue), dNextDay); }
        ...
        private void CheckSidurShabatToAdd(int iRechiv, int iMisparSidur, int iDay, int iSugYom, DateTime dShatHatchalaLetashlum, DateTime dShatGmarLetashlum, DateTime dShatHatchalaSidur, int iMichutzLamichsa, bool bCheckMafil)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->CheckSidurShabatToAdd", ex);
                throw (excep);
            }
        }
        ...
        {   //הפונקציה מקבלת קוד מאפיין,סוג סידור,ערך מאפיין ותאריך ומחזירה האם קיים כזה סוג סידור
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->CheckSugSidur", ex);
                throw (excep);
            }
            finally
            {
        ...
        {    
            ...
            {
                if ((oCalcBL.CheckErevChag(objOved.oGeneralData.dtSugeyYamimMeyuchadim, objOved.SugYom) && !oCalcBL.CheckYomShishi(objOved.SugYom))
                    || objOved.SugYom == enSugYom.Chol.GetHashCode())
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->IsSidur100", ex);
                throw (excep);
            }
            finally
            {
        ...
        private bool IsSidurShaon(DataRow drSidur)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->IsSidurShaon", ex);
                throw (excep);
            }
...
//            drChishuvRows = objOved._dsChishuv.Tables["CHISHUV_SIDUR"].Select("KOD_RECHIV=" + iKodRechiv + " and mispar_sidur=" + iMisparSidur + " AND SHAT_HATCHALA=Convert('" + dShatHatchala.ToString() + "', 'System.DateTime') and taarich=Convert('" + objOved.Taarich.ToShortDateString() + "', 'System.DateTime')");
        ...
        private bool CheckShabat(int iMisparSidur, int iDay, int iSugYom, DateTime dShatHatchalaSidur, DateTime dShatGmarSidur, ref float fErechChol, ref float fErechShabat, bool bCheckMafil)
        {
            ...
            if (iDay == enDay.Shabat.GetHashCode())
            { bShabat = true; }
            else
            {
        ...
        public float GetSumSidurim100(clGeneral.enRechivim kodRechiv)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->GetSumSidurim100", ex);
                throw (excep);
            }
            finally
            {
        ...
        private bool CheckSidurBySectorAvoda(ref DataRow drSidur, int iMisparSidur, int iSectorAvoda)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->CheckSidurBySectorAvoda", ex);
                throw (excep);
            }
            finally
            {
        ...
        public float GetSumShaotShabat100(ref float fDakotShabat)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->GetSumShaotShabat100", ex);
                throw (excep);
            }
            finally
            {
        ...
        public float getDakotRezifutLayla(DateTime dShatHatchalaLetashlum, DateTime dShatGmarLetashlum, DateTime Param1, DateTime Param2)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->getDakotRezifutLayla", ex);
                throw (excep);
            }
        }
        ...
        public float getDakotRezifutBoker(DateTime dShatHatchalaLetashlum, DateTime dShatGmarLetashlum)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->getDakotRezifutBoker", ex);
                throw (excep);
            }
        }
        ...
        private DataRow[] getPeiluyot(int iMisparSidur, DateTime dShatHatchalaSidur, string sCondition)
        {
            ...
            {
                var excep = ServiceLocator.Current.GetInstance<ILogBakashot>().SetError(objOved.iBakashaId, objOved.Mispar_ishi, "E", 0, objOved.Taarich, "CalcSidur-->getPeiluyot", ex);
                throw (excep);
            }
