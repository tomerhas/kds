...
namespace KdsBatch
{
    ...
    {
        public clErua416(long lBakashaId, DataRow drPirteyOved, DataSet dsNetunim)
            : base(lBakashaId, drPirteyOved, dsNetunim, 416)
        {
            _sBody = SetBody();
            if (_sBody != null)
                PrepareLines();
        ...
        protected override List<string> SetBody()
        {
            ...
            try
            {
                ...
                sErua416.Append(FormatNumber(GetErechRechiv(clGeneral.enRechivim.YemeyNochechut.GetHashCode()), 4, 2));
                ...
                {
                    fErech = GetErechRechiv(clGeneral.enRechivim.YomHeadrut.GetHashCode());
                    fErech += GetErechRechivDorB(clGeneral.enRechivim.YomHeadrut.GetHashCode());
                ...
                if ((_iMaamadRashi != clGeneral.enMaamad.Friends.GetHashCode() && _iMaamad != clGeneral.enKodMaamad.Sachir12.GetHashCode() &&
                      _iMaamad != clGeneral.enKodMaamad.OvedBechoze.GetHashCode() && _iMaamad != clGeneral.enKodMaamad.OvedChadshKavua.GetHashCode() &&
                      _iMaamad != clGeneral.enKodMaamad.Aray.GetHashCode() && _iMaamad != clGeneral.enKodMaamad.OvedChadshKavua.GetHashCode()) || 
                ...
                else if ((_iMaamadRashi == clGeneral.enMaamad.Friends.GetHashCode() || _iMaamad == clGeneral.enKodMaamad.OvedBechoze.GetHashCode() || _iMaamad == clGeneral.enKodMaamad.OvedChadshKavua.GetHashCode() ||
                    _iMaamad == clGeneral.enKodMaamad.Aray.GetHashCode() || _iMaamad == clGeneral.enKodMaamad.OvedChadshKavua.GetHashCode()) && _dMonth >= dTakanonSoziali)
                    sErua416.Append(FormatNumber(GetErechRechiv(clGeneral.enRechivim.YomChofesh.GetHashCode()), 4, 2));
                else sErua416.Append(GetBlank(4));
                ...
                if (MaamadDorB())
                {
                    sErua416.Append(FormatNumber(GetErechRechivDorB(clGeneral.enRechivim.YomMachla.GetHashCode()), 4, 2));
                }
                ...
                if (_iMaamad == clGeneral.enKodMaamad.SachirKavua.GetHashCode() || _iMaamad == clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode() ||
                   _iMaamad == clGeneral.enKodMaamad.SachirZmani.GetHashCode() || _iMaamadRashi == clGeneral.enMaamad.Friends.GetHashCode() ||
                   (_iMaamad == clGeneral.enKodMaamad.Sachir12.GetHashCode() && _dMonth >= dTakanonSoziali))
                {
                ...
                if (MaamadDorB())
                {
                    sErua416.Append(FormatNumber(GetErechRechivDorB(clGeneral.enRechivim.YomMachalaYeled.GetHashCode()), 4, 2));
                }
                else  if (_iMaamad == clGeneral.enKodMaamad.SachirKavua.GetHashCode() || _iMaamad == clGeneral.enKodMaamad.ChozeMeyuchad.GetHashCode() ||
                   _iMaamad == clGeneral.enKodMaamad.SachirZmani.GetHashCode() || _iMaamadRashi == clGeneral.enMaamad.Friends.GetHashCode() ||
                   (_iMaamad == clGeneral.enKodMaamad.Sachir12.GetHashCode() && _dMonth >= dTakanonSoziali))
