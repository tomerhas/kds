...
namespace KdsLibrary.KDSLogic.Managers
{
    public class SidurManager : ISidurManager 
    {
        ...
        public SidurDM CreateClsSidurFromSidurayGrira(DataRow dr)
        {
            ...
            cls.sShatHatchala = (cls.dFullShatHatchala.Year < clGeneral.cYearNull ? "" : DateTime.Parse(dr["Shat_Hatchala"].ToString()).ToString("HH:mm"));
            ...
            if (cls.dFullShatHatchalaLetashlum.Year < clGeneral.cYearNull)
        ...
        private bool IsSidurNahagut(SidurDM cls)
        {
            ...
            {
                bSidurNahagut = (int.Parse(cls.sSectorAvoda) == clGeneral.enSectorAvoda.Nahagut.GetHashCode());
            }
        ...
        private bool IsSidurTafkid(SidurDM cls)
        {
            ...
            if (cls.bSectorAvodaExists)
            {
                bSidurTafkid = (int.Parse(cls.sSectorAvoda) == clGeneral.enSectorAvoda.Tafkid.GetHashCode());
            }
            return bSidurTafkid;
        }
