...
namespace KdsLibrary.BL
{
    public class clUtils
    {
        ...
        public DataTable getKodElement(DateTime taarich,string sPrefix,string sKodElementList, string sValue)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        public DataTable getkodSidurimWhithOutList(DateTime taarich,string preFix, string kodMeafyenList, string misSidurList, string sKodElementList)
        {
            DataTable dt = new DataTable();
            try
            {
         ...
         public DataTable GetPirteyOvedForTkufa( int iMispar_ishi,DateTime dTarMe, DateTime dTarAd)
        {
         ...
         public void UpdateLogBakasha(long lRequestNum, DateTime dZmanSiyum, int iStatus)
         {
             ...
             try
             {
                 ...
                 oDal.ExecuteSP(KdsLibrary.clGeneral.cProUpdBakasha);
        ...
        public DataTable GetYechidotLebankShaot(string sPrefix, DateTime sMonth)
        {
            clDal oDal = new clDal();
            DataTable dt = new DataTable();
            try
            {
                oDal.AddParameter("p_yechida", ParameterType.ntOracleVarchar, sPrefix, ParameterDir.pdInput);
                oDal.AddParameter("p_month", ParameterType.ntOracleDate, sMonth, ParameterDir.pdInput);

                oDal.AddParameter("p_Cur", ParameterType.ntOracleRefCursor, null, ParameterDir.pdOutput);
                oDal.ExecuteSP(clGeneral.cProGetYechidotLebank, ref dt);
